package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1735 = param1.invDigit();
         this.var_1734 = this.var_1735 & 32767;
         this.var_2415 = this.var_1735 >> 15;
         this.var_2416 = 131071;
         this.var_2414 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_161) > 0)
         {
