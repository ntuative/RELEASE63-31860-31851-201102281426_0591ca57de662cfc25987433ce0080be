package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1543:int = 10000;
      ...
      private var var_517:ByteArray;
      
      private var var_1198:IEncryption;
      ...
      private var var_518:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_291 = param2;
         this.var_517 = new ByteArray();
         this.var_1197 = new MessageClassManager();
         this.var_80 = new Socket();
         this.var_368 = new Timer(const_1543,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_518)
         {
            this.var_518.connectionInit(param1,param2);
         }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_783.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_518)
         {
            this.var_518.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1198 != null)
         {
            _loc3_ = this.var_1198.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1198 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_783.getMessages(this.var_517,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_518)
               {
                  this.var_518.messageReceived(String(id),data.toString());
               }
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_517,offset);
               this.var_517 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_517.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_517.writeByte(this.var_80.readUnsignedByte());
         }
      }
