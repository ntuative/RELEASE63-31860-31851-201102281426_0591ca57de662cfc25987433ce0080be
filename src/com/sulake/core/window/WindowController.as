package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1216:String = "_COLORIZE";
      
      protected static const const_1666:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1433:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_692 = _loc13_.blend;
            var_445 = _loc13_.var_2733;
      ...
      {
         var_444 = param1;
         var_227 = !!var_444 ? uint(var_227 | var_529) : uint(var_227 & 16777215);
         this.var_164 = this.var_164 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_227 = !!var_444 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_529 = param1 << 24;
         var_227 = !!var_444 ? uint(var_529 | var_227) : uint(16777215 & var_227);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      
      public function set blend(param1:Number) : void
      {
         var_692 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1182);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_83 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_483,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_358 = this._parent.rectangle.clone();
               var_61.x = var_11.x;
               var_61.y = var_11.y;
               var_61.width = var_11.width;
               var_61.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_501,this,this._parent));
            }
            else
            {
               this.var_358.x = 0;
               this.var_358.y = 0;
               this.var_358.width = 0;
               this.var_358.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1173,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_762,var_11);
            this.var_20.visible = var_376;
         }
         return this.var_20;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_18,_context,var_11,null,this.var_652,this.properties,var_800.concat(),_id) as WindowController;
         _loc2_.var_445 = var_445;
         _loc2_.var_164 = this.var_164;
         _loc2_._debug = this._debug;
         _loc2_.var_358 = this.var_358.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2596 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_517)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1118,this,null,true);
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_577,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_191,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_755))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1185;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_191:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_489,this,null));
                     if(testParamFlag(WindowParam.const_174,WindowParam.const_155))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_193,WindowParam.const_160))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_297,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_577:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_550);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1153,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_292,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_359:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_826,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_230,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_512:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1014);
                  break;
               ...
               case WindowNotifyEvent.const_464:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_550);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_489:
                  this._parent.getRegionProperties(null,this.var_358);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1076:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1618:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1119:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_555:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1057:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1156:
               _loc2_ = "null";
               _loc4_ = true;
               break;
         ...
         if(this.var_164 && var_445 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1433,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1433,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_144,WindowParam.const_155);
         var _loc2_:* = !testParamFlag(WindowParam.const_139,WindowParam.const_160);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_358.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_358.height;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_315)
               {
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1020;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_359;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1094,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_687;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1171,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1163 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_387,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1163 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_790,this,param1));
         return param1;
      }
