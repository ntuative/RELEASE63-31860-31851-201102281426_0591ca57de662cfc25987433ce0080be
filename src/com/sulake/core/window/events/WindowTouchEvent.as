package com.sulake.core.window.events
{
   ...
   public class WindowTouchEvent extends WindowEvent
   {
      ...
      public static const const_1085:String = "WTE_END";
      
      public static const const_1793:String = "WTE_MOVE";
      
      public static const const_1908:String = "WTE_OUT";
      
      public static const const_1740:String = "WTE_OVER";
      
      public static const const_1882:String = "WTE_ROLL_OUT";
      ...
      {
         return new WindowTouchEvent(_type,window,related,this.localX,this.localY,this.sizeX,this.sizeY,this.stageX,this.stageY,this.var_2734,this.altKey,this.ctrlKey,this.shiftKey,bubbles,cancelable);
      }
