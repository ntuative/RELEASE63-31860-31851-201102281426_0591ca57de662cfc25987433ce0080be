package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_303 = param1;
         if(this.var_303 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_303)
         {
            this._target.width = this.var_303;
         }
      }
      ...
      {
         this.var_302 = param1;
         if(this.var_302 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_302)
         {
            this._target.height = this.var_302;
         }
      }
      ...
      {
         this.var_304 = param1;
         if(this.var_304 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_304)
         {
            this._target.height = this.var_304;
         }
      }
      
      public function get isEmpty() : Boolean
      {
         return this.var_303 == int.MIN_VALUE && this.var_305 == int.MAX_VALUE && this.var_302 == int.MIN_VALUE && this.var_304 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_303)
            {
               this._target.width = this.var_303;
            }
            ...
            if(this._target.height < this.var_302)
            {
               this._target.height = this.var_302;
            }
            else if(this._target.height > this.var_304)
            {
               this._target.height = this.var_304;
            }
         }
