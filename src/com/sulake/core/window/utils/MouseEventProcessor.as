package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_799:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_82 = param1.var_1219 as WindowController;
         this._lastClickTarget = param1.var_1221 as WindowController;
         this.var_149 = param1.renderer;
         this.var_799 = param1.var_1220;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_648.x || _loc3_.stageY != this.var_648.y)
            {
               this.var_648.x = _loc3_.stageX;
               this.var_648.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_135.groupParameterFilteredChildrenUnderPoint(this.var_648,_loc6_,WindowParam.const_30);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_82 && !this.var_82.disposed)
                     {
                        ...
                        {
                           this.var_799.mouseEventReceived(_loc3_.type,this.var_82);
                        }
                     }
                  }
         ...
         param1.var_1219 = this.var_82;
         param1.var_1221 = this._lastClickTarget;
         param1.renderer = this.var_149;
         param1.var_1220 = this.var_799;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testStateFlag(WindowState.const_80))
         {
            return null;
         }
