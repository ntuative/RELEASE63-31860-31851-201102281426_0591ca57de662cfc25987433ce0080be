package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1065:String = "_EXCLUDE";
      
      public static const const_1934:String = "_INCLUDE";
      
      public static const const_1868:String = "_TEMP";
      
      private static const const_1344:String = "layout";
      
      private static const const_956:String = "window";
      
      private static const const_955:String = "variables";
      
      private static const const_954:String = "filters";
      
      private static const const_602:String = "name";
      
      private static const const_1329:String = "style";
      
      private static const const_601:String = "params";
      
      private static const const_1335:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1338:String = "width";
      
      private static const const_1340:String = "height";
      
      private static const const_1331:String = "visible";
      
      private static const const_1332:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1182:String = "blend";
      
      private static const const_1336:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1342:String = "treshold";
      
      private static const const_1328:String = "children";
      
      private static const const_1339:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1333:String = "height_min";
      
      private static const const_1330:String = "height_max";
      
      private static const const_600:String = "true";
      
      private static const const_161:String = "0";
      
      private static const const_1337:String = "$";
      
      private static const const_1341:String = ",";
      
      private static const const_47:String = "";
      
      private static const const_1343:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1334:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1235:Dictionary;
      
      protected var var_1236:Dictionary;
      
      protected var var_998:Dictionary;
      
      protected var var_1489:Dictionary;
      
      protected var var_1988:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1235,this.var_1236);
         this.var_998 = new Dictionary();
         this.var_1489 = new Dictionary();
         ParamCodeTable.fillTables(this.var_998,this.var_1489);
         this.var_1988 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1334,const_47);
         return param1.replace(const_1343,const_47);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1236)
            {
               delete this.var_1236[_loc1_];
            }
            for(_loc1_ in this.var_998)
            {
               delete this.var_998[_loc1_];
            }
            for(_loc1_ in this.var_1489)
            {
               delete this.var_1489[_loc1_];
            }
            this.var_1988.dispose();
            this.var_1988 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1344)
         {
            _loc8_ = param1.child(const_955);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_954).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_602,variables,"")));
         style = uint(this.parseAttribute(xml,const_1329,variables,style));
         params = uint(this.parseAttribute(xml,const_601,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1335,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_161));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_161));
         rect.width = Number(this.parseAttribute(xml,const_1338,variables,const_161));
         rect.height = Number(this.parseAttribute(xml,const_1340,variables,const_161));
         visible = this.parseAttribute(xml,const_1331,variables,visible.toString()) == const_600;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_601).length() > 0)
         {
            list = xml.child(const_601).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_602,variables,"") as String;
               if(this.var_998[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_602)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1332,variables,caption)));
         if(tag != const_47)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_955)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1339,variables,window.limits.minWidth));
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1330,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_600;
         blend = Number(this.parseAttribute(xml,const_1182,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1336,variables,window.clipping.toString()) == const_600;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1342,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_954).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1236[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1065) == -1)
                  {
