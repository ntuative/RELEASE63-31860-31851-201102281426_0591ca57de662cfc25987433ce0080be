package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_176:String = "regular";
      ...
      private static var var_504:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_604:String = "{";
      
      private static const const_603:String = "}";
      
      private static const const_1345:String = "/*";
      
      private static const const_1346:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_86[const_176],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_176] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_504.indexOf(_loc4_.name) == -1)
            {
               var_504.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_603);
         if(countSubStrings(param1,const_604) != countSubStrings(param1,const_603))
         {
            throw new Error("Mismatching amount of \"" + const_604 + "\" versus \"" + const_603 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1345) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1346) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_604)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
