package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1250:String = "skin";
      
      private static const const_1253:String = "bitmap";
      
      private static const const_1251:String = "fill";
      
      private static const const_1254:String = "text";
      
      private static const const_1255:String = "label";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1580,this.var_2178);
         this.var_2180 = new Dictionary();
         this.var_2179 = new Dictionary();
         StateCodeTable.fillTables(this.var_2180,this.var_2179);
         this.var_389 = new Dictionary();
         this.var_389[const_1250] = BitmapSkinRenderer;
         this.var_389[const_1253] = BitmapDataRenderer;
         this.var_389[const_1251] = FillSkinRenderer;
         this.var_389[const_1254] = TextSkinRenderer;
         this.var_389[const_1255] = LabelRenderer;
         this.var_389[const_1252] = ShapeSkinRenderer;
         this.var_389[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_389[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_316 == null)
         {
            var_316 = new Array();
            var_316.push(WindowState.const_72);
            var_316.push(WindowState.const_80);
            var_316.push(WindowState.const_84);
            var_316.push(WindowState.const_54);
            var_316.push(WindowState.const_88);
            var_316.push(WindowState.const_83);
            var_316.push(WindowState.const_107);
            var_316.push(WindowState.const_100);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2733 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1580[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_844[param1] == null)
         {
            this.var_844[param1] = new Array(const_911);
         }
         this.var_844[param1][param2] = param3;
         if(this.var_845[param1] == null)
         {
            this.var_845[param1] = new Array(const_911);
         }
         this.var_845[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_844[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_182)
            {
               _loc4_ = _loc3_["null"];
            }
         }
