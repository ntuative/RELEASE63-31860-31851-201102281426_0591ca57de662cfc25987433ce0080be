         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_290)
                  {
                     var_33.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_495)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_301)
                  {
                     _loc12_ = true;
                     var_33.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_290)
                  {
                     var_33.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_495)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_301)
                  {
                     _loc13_ = true;
                     var_33.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_301 || _loc10_.scaleH == SkinLayoutEntity.const_301)
                  {
                  ...
                  {
                     this.var_819.a = 0 / _loc17_.width;
                     this.var_819.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_33.width,var_33.height,false);
                     _loc30_.draw(_loc17_,this.var_819);
                     _loc31_ = new BitmapData(var_33.width,var_33.height,true,0);
                     _loc31_.draw(_loc18_,this.var_819,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_290)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_290)
               {
