package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1435:uint = 0;
      
      public static const const_762:uint = 1;
      
      public static const const_972:uint = 2;
      
      public static const const_667:uint = 4;
      
      public static const const_1393:uint = 8;
      
      public static const const_1620:uint = 16;
      
      public static const const_1947:uint = 64;
      
      public static const const_1834:uint = 128;
      
      public static const const_1030:uint = 256;
      ...
      protected var var_201:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_972:
               ...
               break;
            case GraphicContext.const_1393:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1620:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_667:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1030:
               break;
            case GraphicContext.const_1435:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_201.numChildren > 0)
               {
                  this.var_201.removeChildAt(0);
               }
            }
            this.var_201 = null;
            while(numChildren > 0)
         ...
         if(this.var_807)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1998,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1998,16777215);
                  }
                  var_317 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_201 == null)
         {
            this.var_201 = new Sprite();
            this.var_201.name = this.name + " - Child Container";
            this.var_201.mouseEnabled = false;
            addChild(this.var_201);
         }
         return this.var_201;
      }
      ...
      {
         return this.var_201 != null ? int(this.var_201.numChildren) : 0;
      }
