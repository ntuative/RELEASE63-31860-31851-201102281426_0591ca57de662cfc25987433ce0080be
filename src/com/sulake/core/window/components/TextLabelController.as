package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_356:Object = null;
      ...
      {
         return this.var_356 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_419);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_356 != null)
            {
               _loc1_.textColor = uint(this.var_356);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_419 != param1.name)
         {
            this.var_419 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2555 = _loc2_.textWidth;
         this.var_2556 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_356 != _loc2_.color : this.var_356 != null && this.var_356 != PropertyDefaults.const_751) ? new PropertyStruct(PropertyDefaults.const_382,this.var_356,PropertyStruct.const_150,true) : PropertyDefaults.const_1149);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_641)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,this.var_40.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_436);
            }
            if(this.var_40.top != PropertyDefaults.const_855)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_227,this.var_40.top,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_493);
            }
            if(this.var_40.right != PropertyDefaults.const_859)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,this.var_40.right,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_570);
            }
            if(this.var_40.bottom != PropertyDefaults.const_635)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_252,this.var_40.bottom,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_551);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_382:
                  this.var_356 = _loc2_.value as uint;
                  break;
               ...
               case PropertyDefaults.const_227:
                  ...
                  break;
               case PropertyDefaults.const_228:
                  if(this.var_40 || _loc2_.valid)
                  {
