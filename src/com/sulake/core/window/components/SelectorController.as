package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_200:ISelectableWindow;
      
      protected var var_1978:Boolean = true;
      ...
      {
         return this.var_200 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_200)
            {
               if(this.var_200 != null)
               {
                  this.var_200.unselect();
               }
               this.var_200 = param1;
               this.var_200.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_398,this,this.var_200));
               }
            }
         }
      }
