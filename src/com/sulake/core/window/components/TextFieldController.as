package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_767:Boolean = false;
      ...
      {
         this.var_1238 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_972,var_11);
         }
         return var_20;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_767 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_348,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_750,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1407);
         _loc1_.push(this.var_1232 != PropertyDefaults.const_1186 ? new PropertyStruct(PropertyDefaults.const_858,this.var_1232,PropertyStruct.const_35,true) : PropertyDefaults.const_1367);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1131 ? new PropertyStruct(PropertyDefaults.const_703,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1412);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1121 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1504);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_750:
                  ...
                  break;
               case PropertyDefaults.const_1150:
