package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_104:Number;
      
      protected var var_92:Number;
      
      protected var _container:IWindowContainer;
      
      protected var var_1981:Boolean = false;
      ...
      protected var var_2802:Number = 0.0;
      
      protected var var_2801:Number = 0.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_362,WindowStyle.const_896,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_48,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_429,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_285,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_580,this.containerEventHandler);
      ...
      {
         var _loc1_:int = this.var_104 - width;
      ...
      {
         return new Rectangle(this.var_646 * this.maxScrollH,this.var_647 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_646 = param1;
            this._container.x = -this.var_646 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_71);
            dispatchEvent(new WindowEvent(WindowEvent.const_569,this,null));
         }
      }
      ...
      {
         this.var_2802 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2801 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_438,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_426,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_429,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_285,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_580,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(this._horizontal)
         {
            param1.x = this.var_104 + (this.numListItems > 0 ? this._spacing : 0);
            this.var_104 = param1.rectangle.right;
            this._container.width = this.var_104;
         }
         else
         {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_183:
               if(this.var_1228)
               {
                  this.var_1230 = this.var_1979 - _loc3_;
                  this.var_1231 = this.var_1980 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1230 != 0 && this.var_104 != 0)
                     {
                        this.scrollH += this.var_1230 / this.var_104;
                     }
                  }
                  else if(this.var_1231 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1231 / this.var_92;
                  }
                  this.var_1979 = _loc3_;
                  this.var_1980 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_171:
               if(this.var_1228)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1230,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1231);
                  }
                  this.var_1228 = false;
                  _loc2_ = true;
               }
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            this.scrollH -= param1 / this.var_104;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_993 && !this.var_527 && this._container)
         {
            this.var_527 = true;
            ...
            if(this._horizontal)
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.x = this.var_104;
                     this.var_104 += _loc2_.width + this._spacing;
                     if(this.var_440)
                     {
               ...
               if(_loc1_ > 0)
               {
                  this.var_104 -= this._spacing;
               }
            }
            else
            {
               this.var_104 = var_11.width;
               this.var_92 = 0;
               _loc4_ = 0;
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(this.var_440)
                     {
                        ...
                        this.var_104 = _loc3_ > this.var_104 ? Number(_loc3_) : Number(this.var_104);
                     }
                  }
                  _loc4_++;
               }
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_639)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_370,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1022);
         }
         if(this.var_993 != PropertyDefaults.const_997)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_818,this.var_993,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1596);
         }
         if(this.var_440 != PropertyDefaults.const_1023)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_852,this.var_440,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1553);
         }
         if(this.var_1229 != PropertyDefaults.const_1038)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_814,this.var_1229,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1536);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_370:
                  ...
                  break;
               case PropertyDefaults.const_852:
