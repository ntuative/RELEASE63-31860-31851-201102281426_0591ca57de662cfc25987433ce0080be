package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1215:Dictionary = createPropertySetterTable();
      ...
      protected var var_994:Boolean = false;
      
      private var var_419:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_419,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_419 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_419,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_176);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_705 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_419);
      }
      ...
      {
         return new Rectangle(this.var_803 * this.maxScrollH,this.var_531 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_419);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1058) ? new PropertyStruct(PropertyDefaults.const_863,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1141) : PropertyDefaults.const_1546);
         _loc1_.push(this._autoSize != PropertyDefaults.const_978 ? new PropertyStruct(PropertyDefaults.const_657,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1062) : PropertyDefaults.const_1392);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_248,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1214 ? new PropertyStruct(PropertyDefaults.const_1039,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1026) : PropertyDefaults.const_1436);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_751) ? new PropertyStruct(PropertyDefaults.const_382,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1149);
         _loc1_.push(this.var_419 != TextStyleManager.const_176 ? new PropertyStruct(PropertyDefaults.const_339,this.var_419,PropertyStruct.const_53,true,PropertyDefaults.const_881) : PropertyDefaults.const_1174);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_641 ? new PropertyStruct(PropertyDefaults.const_249,this.var_40.left,PropertyStruct.const_39,true) : PropertyDefaults.const_436);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_855 ? new PropertyStruct(PropertyDefaults.const_227,this.var_40.top,PropertyStruct.const_39,true) : PropertyDefaults.const_493);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_859 ? new PropertyStruct(PropertyDefaults.const_228,this.var_40.right,PropertyStruct.const_39,true) : PropertyDefaults.const_570);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_635 ? new PropertyStruct(PropertyDefaults.const_252,this.var_40.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_551);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1028 ? new PropertyStruct(PropertyDefaults.const_786,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1431);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_247,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_247,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_247,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
