package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1227:String = "_SELECTOR";
      
      private static const const_1228:String = "_CONTENT";
       
      
      protected var var_991:ITabSelectorWindow;
      
      protected var var_1976:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_991 = findChildByTag(const_1227) as ITabSelectorWindow;
            if(this.var_991 != null)
            {
               this.var_991.procedure = this.selectorEventProc;
            }
         }
         return this.var_991;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1976 = findChildByTag(const_1228) as IWindowContainer;
         }
      ...
      {
         return !!this.var_767 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_991.numSelectables;
      }
