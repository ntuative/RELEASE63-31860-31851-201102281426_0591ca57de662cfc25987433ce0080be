package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1290:String = "increment";
      
      private static const const_1289:String = "decrement";
      
      private static const const_924:String = "slider_track";
      
      private static const const_597:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_649:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_569,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_569,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_878 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_924) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_597) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_597:
         ...
         if(param2.type == WindowNotifyEvent.const_501)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_296)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_649;
                  }
                  else
                  {
                     this.scrollV -= this.var_649;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_552)
         {
            ...
            else if(param2.name == const_1289)
            {
               if(this.var_17)
               {
                  this.var_1080 = true;
            ...
            else if(param2.name == const_924)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_597).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_296)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_878) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_878) as IScrollableWindow;
               if(_loc1_)
               {
