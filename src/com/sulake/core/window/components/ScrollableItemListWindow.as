package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_80))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_392)
         {
            this.var_392.removeEventListener(WindowEvent.const_288,this.scrollBarEventProc);
            this.var_392.removeEventListener(WindowEvent.const_219,this.scrollBarEventProc);
            this.var_392 = null;
         }
         if(this.var_1033)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1033)
         {
            this.var_1033 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_392)
         {
            ...
            if(this.var_392)
            {
               this.var_392.addEventListener(WindowEvent.const_288,this.scrollBarEventProc);
               this.var_392.addEventListener(WindowEvent.const_219,this.scrollBarEventProc);
            }
         }
         return this.var_392;
      }
