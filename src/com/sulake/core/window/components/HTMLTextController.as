package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_836:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_667:String;
      
      private var var_1024:String = null;
      
      private var var_1561:StyleSheet = null;
      ...
      {
         this.var_667 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1024 == param2)
         {
            return;
         }
         param1.var_1024 = param2;
         param1.var_1561 = null;
         if(param1.var_1024 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1024);
            param1.var_1561 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_622.indexOf(param1) > -1)
         {
            this.var_667 = param1;
         }
      }
      ...
      {
         return this.var_667 == LinkTarget.const_31 ? defaultLinkTarget : this.var_667;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1561;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_667 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_765,this.var_667,PropertyStruct.const_53,true,PropertyDefaults.const_622));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_765)
            {
               this.var_667 = _loc2_.value as String;
               break;
            }
