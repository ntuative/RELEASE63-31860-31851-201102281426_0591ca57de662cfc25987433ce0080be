package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1279:String = "_TITLE";
      
      private static const const_1278:String = "_HEADER";
      
      private static const const_1280:String = "_CONTENT";
      
      private static const const_1281:String = "_SCALER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1279) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1323 = findChildByTag(const_1278) as IHeaderWindow;
            if(!this.var_1323)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_176 = findChildByTag(const_1280) as IWindowContainer;
            if(!this.var_176)
            {
      ...
      {
         return findChildByTag(const_1281) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1216,_loc2_,false);
      ...
      {
         return this.content != null && this.var_997 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_271);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_250);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_250,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_250,false);
            }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,_loc3_.left,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_227,_loc3_.top,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_252,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         }
         else
         {
