package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1234:String = "asset-libraries";
      
      private static const const_1237:String = "library";
      
      private static const const_1241:String = "service-libraries";
      
      private static const const_1238:String = "library";
      
      private static const const_1235:String = "component-libraries";
      
      private static const const_1240:String = "library";
      
      private static const const_1239:String = "error_data";
      
      private static const const_1236:String = "error_cat";
      
      private static const const_1233:String = "error_desc";
       
      
      private var var_323:LibraryLoaderQueue;
      
      private var var_664:IEventDispatcher;
      
      private var var_456:uint;
      
      private var var_385:Function;
      
      private var var_231:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_386.push(new Array());
            this.var_549.push(0);
            _loc3_++;
         }
         this._lastUpdateTimeMs = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_448.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1086:
            ...
            case Core.const_741:
               ...
               break;
            case Core.const_1576:
               debug("Core; using profiler frame update handler");
               this.var_385 = this.profilerFrameUpdateHandler;
               this.var_231 = new Profiler(this);
               attachComponent(this.var_231,[new IIDProfiler()]);
               var_448.addChild(new ProfilerViewer(this.var_231));
               break;
            case Core.const_621:
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_448.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_448 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_123)
            {
               _loc2_ = this.var_386[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1239,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1236,String(param3));
         ErrorReportStorage.setParameter(const_1233,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_664 = loadingEventDelegate;
         if(this.var_323 == null)
         {
            this.var_323 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1234)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1577);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_664)
         {
            this.var_664.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_664)
         {
            ...
            this.var_664.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_664)
                  {
                     this.var_664.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_456 - this.var_323.length,this.var_456,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_386[param2] as Array;
         if((this.var_1271 & 0) == Core.const_621)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_386[_loc4_] as Array;
            if((this.var_1271 & 0) == Core.const_621)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_549[criticality] = 0;
            receivers = this.var_386[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_448.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_123)
         {
            ...
            {
               if(this.var_549[priority] < priority)
               {
                  ++this.var_549[priority];
                  skip = true;
               }
            }
            if(!skip)
            {
               this.var_549[priority] = 0;
               receivers = this.var_386[priority];
               index = 0;
               length = receivers.length;
               while(index != length)
               {
         ...
         while(priority < CoreComponentContext.const_123)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_231.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_231)
            {
               detachComponent(this.var_231);
               this.var_231.dispose();
               this.var_231 = null;
            }
            switch(this.var_1271 & 0)
            {
               case Core.const_1086:
                  this.var_385 = this.simpleFrameUpdateHandler;
                  break;
