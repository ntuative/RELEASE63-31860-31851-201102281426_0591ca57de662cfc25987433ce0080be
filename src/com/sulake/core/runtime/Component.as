package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1864:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1169:uint = 4;
       
      
      protected var var_679:uint = 0;
      
      protected var var_1224:String = "";
      ...
      private var var_507:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_507 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_507.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_507.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1224 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1224);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1271 & const_1169)
         {
            if(_loc3_ == 0)
            {
               if(this.var_507.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_679 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_507.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_507.getStructByIndex(_loc8_);
