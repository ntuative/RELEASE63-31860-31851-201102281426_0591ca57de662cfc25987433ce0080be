package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1415:String = "bool";
      ...
      private static const const_970:String = "type";
      
      private static const const_610:String = "value";
      
      private static const const_600:String = "true";
      
      private static const const_1716:String = "QuestVendingWallItemMessageComposer";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_970);
         if(_loc7_.length() > 0)
         {
            _loc5_ = String(param1.attribute(const_970));
         }
         ...
         else
         {
            ...
            else if(_loc5_ == const_231 || _loc5_ == const_145)
            {
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_233:
               ...
               _loc5_.width = Number(param1.attribute(const_1338));
               _loc5_.height = Number(param1.attribute(const_1340));
               return _loc5_;
            case const_145:
               _loc3_ = new Map();
