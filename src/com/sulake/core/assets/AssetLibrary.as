package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1049:String = "AssetLibraryReady";
      
      public static const const_795:String = "AssetLibraryLoaded";
      
      public static const const_1476:String = "AssetLibraryUnloaded";
      
      public static const const_1639:String = "AssetLibraryLoadError";
      ...
      private static var var_828:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_452;
         this.var_383 = new Dictionary(false);
         this.var_453 = new Dictionary(false);
         this.var_827 = new Dictionary(false);
         this.var_144 = new Dictionary(false);
         var_828.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_828.splice(var_828.indexOf(this),1);
            --var_452;
            this.var_453 = null;
            this.var_827 = null;
            this.var_144 = null;
      ...
      {
         if(this._file == param1.url && this.var_830)
         {
            if(!this.var_829 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_660,this.var_546);
            }
            this.var_829 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1049));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_453)
         {
            _loc2_ = this.var_453[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_453[_loc1_];
         }
         for(_loc1_ in this.var_144)
         {
            delete this.var_144[_loc1_];
         }
         for(_loc1_ in this.var_827)
         {
            delete this.var_827[_loc1_];
         }
         if(this.var_41 != null)
         {
            this.var_41.dispose();
      ...
      {
         var _loc2_:Class = this.var_827[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_453[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1137,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1203,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_453[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_453[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_144[struct.assetName] == null)
                  {
                     ++this.var_384;
                     this.var_382.push(struct.assetName);
                  }
                  this.var_144[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_46,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_453[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_144[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_382.length ? this.getAssetByName(this.var_382[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_144)
         {
            if(this.var_144[_loc2_] == param1)
            {
               return this.var_382.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_144[param1] != null || (this.var_546 != null ? this.var_546[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_144[param1] == null;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_144)
            {
               if(this.var_144[_loc2_] == param1)
               {
                  this.var_382.splice(this.var_382.indexOf(_loc2_),1);
                  delete this.var_144[_loc2_];
                  --this.var_384;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_383.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_383[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_383[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_383)
         {
            _loc3_ = AssetTypeDeclaration(this.var_383[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_383)
         {
            _loc4_ = AssetTypeDeclaration(this.var_383[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_660 = _loc2_.manifest.copy();
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1639));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_660.child("library");
         if(_loc2_ == null)
         {
