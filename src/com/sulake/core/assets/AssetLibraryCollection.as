package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_439:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_992 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_439 = new AssetLibrary("lib-" + this.var_535++);
         this.var_28.push(this.var_439);
      }
      ...
      {
         return this.var_439.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_526.length > 0)
         {
            (this.var_526.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_526.length)
            {
               _loc3_ = this.var_526[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_526.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return this.var_439.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_439.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_439.createAsset(param1,param2);
      }
      ...
      {
         return this.var_439.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_439.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_439.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_439.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
