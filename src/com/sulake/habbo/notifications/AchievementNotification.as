package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1714:String = "badge_bg_001_png";
      
      private const const_1980:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1468 = param7;
         this.var_2476 = param5;
         this.var_1923 = param6;
         this.var_79 = param10;
         this._assets = param8;
         this.var_393 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_130,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2694 = this.var_79.getBadgeName(this.var_311);
         this.var_2692 = this.var_79.getBadgeDesc(this.var_311);
         this.var_2690 = this.var_79.getAchievementNameForFacebook(this.var_311,this.var_393.userName,this.var_393.realName,this.var_1467);
         this.var_2693 = this.var_79.getAchievementDescForFacebook(this.var_311,this.var_393.userName,this.var_393.realName,this.var_1467);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2695 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_79.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1760.toString());
         this.var_79.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1468.toString());
         this.var_79.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1468.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1923;
         var _loc17_:String = this.var_1923 == 0 ? "pixels" : "activitypoints";
         this.var_79.registerParameter(_loc16_,_loc17_,"" + this.var_2476);
         _loc15_.caption = this.var_79.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1714);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1980) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_79.registerParameter(param1,"badge_name",this.var_2694);
         this.var_79.registerParameter(param1,"badge_desc",this.var_2692);
         this.var_79.registerParameter(param1,"badge_name_fb",this.var_2690);
         this.var_79.registerParameter(param1,"badge_desc_fb",this.var_2693);
         this.var_79.registerParameter(param1,"level",this.var_1467.toString());
         this.var_79.registerParameter(param1,"name",this.var_393.userName);
         return this.var_79.registerParameter(param1,"realname",this.var_393.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_393.events.removeEventListener(BadgeImageReadyEvent.const_130,this.onBadgeImageReady);
            this.var_393 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1714);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_311,this._feedTitleFb,this.var_2695,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2691));
