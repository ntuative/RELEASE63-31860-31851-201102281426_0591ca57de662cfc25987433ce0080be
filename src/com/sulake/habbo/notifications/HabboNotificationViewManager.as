package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_930:int = 32;
      
      private static const const_1297:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2411,this.var_401,this.var_173,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_768 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_930;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_219.length)
         {
            _loc3_ = this.var_219[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_768 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_768 + const_1297;
            _loc2_++;
         }
         return _loc1_;
      }
