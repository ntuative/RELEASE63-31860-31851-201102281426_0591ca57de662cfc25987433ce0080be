package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_75.roomEngine.getRoomObject(this.var_75.roomId,this.var_75.roomCategory,param1,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
