package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1321:int = 2;
       
      
      private var var_75:HabboUserDefinedRoomEvents;
      
      private var _window:IFrameWindow;
      
      private var var_50:IWindowContainer;
      
      private var var_1641:TriggerConfs;
      
      private var var_1639:ActionTypes;
      
      private var var_1640:ConditionTypes;
      
      private var var_239:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_690:RoomObjectHightLighter;
      
      private var var_177:UserDefinedRoomEventsHelp;
      
      private var var_1056:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1641 = new TriggerConfs();
         this.var_1639 = new ActionTypes();
         this.var_1640 = new ConditionTypes();
         this.var_239 = new Dictionary();
         super();
         this.var_75 = param1;
         this.var_690 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_239[param1])
         {
            delete this.var_239[param1];
            this.var_690.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_35.furniLimit)
         {
            this.var_239[param1] = param2;
            this.var_690.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_75.getXmlWindow("ude_main"));
         ...
         this.var_1056 = new SliderWindowController(this.var_75,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_75.assets,0,20,1);
         this.var_1056.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1056.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_75.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_75.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_690.hideAll(this.var_239);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_35.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_75.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_75.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_35.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_35 as TriggerDefinition != null)
         {
            this.var_75.send(new UpdateTriggerMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ActionDefinition != null)
         {
            this.var_75.send(new UpdateActionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ConditionDefinition != null)
         {
            this.var_75.send(new UpdateConditionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1056.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1321) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1321 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_75.send(new ApplySnapshotMessageComposer(this.var_35.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1641);
         this.refreshConfigureElement(this.var_1639);
         this.refreshConfigureElement(this.var_1640);
      ...
      {
         var _loc2_:IFurnitureData = this.var_75.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         this.var_75.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_75.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_75.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         this.var_75.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_75.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_75.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_75.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_75);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         this.var_75.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_75.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
