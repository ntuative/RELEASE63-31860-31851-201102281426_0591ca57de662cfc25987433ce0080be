package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1075:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1075.getValue());
      ...
      {
         this.var_75 = param2;
         this.var_1075 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1075.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1075.setValue(1);
         this.var_1076 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1076.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1076.setValue(50);
      }
      ...
      private function onMinSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_75.localization.registerParameter("wiredfurni.params.usercountmin","value","" + _loc4_);
            }
         }
      }
      ...
      private function onMaxSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               _loc3_ = _loc2_.getValue();
               _loc4_ = int(_loc3_);
               this.var_75.localization.registerParameter("wiredfurni.params.usercountmax","value","" + _loc4_);
            }
         }
      }
   }
