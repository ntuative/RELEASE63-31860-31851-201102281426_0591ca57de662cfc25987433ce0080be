package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1313:uint = 13232628;
      
      private static var var_1635:uint = 11129827;
      ...
      private var var_1049:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_275;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_467 = param1;
         if(this.var_1634 == this.var_467)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1633 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_687)
         {
            this.var_687 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_687)
            {
               return;
            }
            this._window.content.addChild(this.var_687);
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_467);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_987 || param1 == ChangeUserNameResultMessageEvent.var_988)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1049 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1049.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1313;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_467 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_467);
               break;
