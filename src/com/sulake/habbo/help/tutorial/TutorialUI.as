package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_275:String = "TUI_NAME_VIEW";
      ...
      private var var_365:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_456,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_566,this.onTaskDoneEvent);
      ...
      {
         return this.var_1186 && this.var_1185 && this.var_1449;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            ...
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_456,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_566,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_42 == null || this.var_42.id == const_86)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_567:
               this.var_1449 = true;
               if(this.var_42 != null && this.var_42.id == const_490)
               {
                  this.showView(const_86);
               }
               break;
            case HabboHelpTutorialEvent.const_456:
               if(this.var_42 != null && this.var_42.id == const_404)
               {
                  this.var_1898 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2123 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_275:
               ...
               if(this.var_365 == null)
               {
                  this.var_365 = new NameChangeView(this);
               }
               this.var_365.showMainView();
               this.prepareForTutorial();
               break;
            case const_404:
         ...
         this._window.height = _loc2_.height + this.var_2125;
         this._window.width = _loc2_.width + this.var_2123;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_42 != null && (this.var_42.id == const_275 || this.var_42.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      {
         this.var_1186 = true;
         if(this.var_42 != null && (this.var_42.id == const_404 || this.var_42.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_365.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_525)
         {
            this.var_365.checkedName = _loc2_.name;
         }
         else
         {
            this.var_365.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
