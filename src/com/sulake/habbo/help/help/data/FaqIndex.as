package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_757:FaqCategory;
      
      private var var_759:FaqCategory;
      
      private var var_758:FaqCategory;
      ...
      {
         super();
         this.var_757 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_759 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_758 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_757.hasItem(param1))
         {
            this.var_757.getItem(param1).answerText = param2;
         }
         if(this.var_759.hasItem(param1))
         {
            this.var_759.getItem(param1).answerText = param2;
         }
         if(this.var_758.hasItem(param1))
         {
            this.var_758.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_757.hasItem(param1))
         {
            return this.var_757.getItem(param1);
         }
         if(this.var_759.hasItem(param1))
         {
            return this.var_759.getItem(param1);
         }
         if(this.var_758.hasItem(param1))
         {
            return this.var_758.getItem(param1);
         }
         var _loc2_:int = 0;
