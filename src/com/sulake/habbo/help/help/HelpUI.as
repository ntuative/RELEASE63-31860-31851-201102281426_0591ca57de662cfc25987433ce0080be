package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102281421));
         this.var_173 = param5;
         this.var_107 = new Map();
         this.var_107.add(HabboHelpViewEnum.const_1419,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_195,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_437,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_304,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_258,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_394,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_669,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_253,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_107.add(HabboHelpViewEnum.const_1120,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_107.add(HabboHelpViewEnum.const_1132,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_694,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_107.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_107.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_455.length == 0 || param1 != this.var_321)
            {
               this.var_455.push(this.var_321);
            }
         }
         this.var_321 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_253:
               this.showUI(HabboHelpViewEnum.const_253);
               break;
            case CallForHelpResultEnum.const_1001:
               this.showUI(HabboHelpViewEnum.const_1132);
               break;
            case CallForHelpResultEnum.const_1044:
               this.showUI(HabboHelpViewEnum.const_1120);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_107.getValue(HabboHelpViewEnum.const_195) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_567));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_107.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_107.getValue(this.var_321);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2123 = this._window.width - _loc4_.width;
         this.var_2125 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2125;
         this._window.width = _loc1_.width + this.var_2123;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_455.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_321 == HabboHelpViewEnum.const_195)
         {
            return;
         }
         if(this.var_548.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_548.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_548.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_322.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_548[1],this.var_548[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_548[0],this.var_548[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_321 == HabboHelpViewEnum.const_195 || this.var_455.length == 0)
         {
            return;
         }
         if(this.var_322 == null)
         {
            ...
            this.var_322 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_322.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_322.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_322 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_322 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_322 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
