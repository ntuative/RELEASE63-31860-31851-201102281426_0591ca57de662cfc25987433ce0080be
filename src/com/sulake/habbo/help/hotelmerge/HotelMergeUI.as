package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeUI implements INameChangeUI
   {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         this.var_177.windowManager.alert("${generic.notice}","${help.tutorial.name.changed}",0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
      ...
      public function buildXmlWindow(param1:String, param2:uint = 1) : IWindow
      {
         ...
         var _loc4_:ICoreWindowManager = ICoreWindowManager(this.var_177.windowManager);
