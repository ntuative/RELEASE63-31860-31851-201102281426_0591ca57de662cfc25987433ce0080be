package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_309:QuestView;
      
      private var var_2666:Boolean = false;
      
      private var _window:IWindowContainer;
      
      private var var_1194:IWindowContainer;
      ...
      private var var_1193:IWindowContainer;
      
      private var var_177:QuestHelp;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_177 = new QuestHelp(this);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1194 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1453 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_308 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1453.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1453.findChildByName("currency.amount").caption = "${quest_" + this.var_1905 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1193 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1193)
         {
            this.var_1193.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1193.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1193.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_177)
         {
            this.var_1194.addChild(this.var_177.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1765);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1453.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_367.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_367)
         {
            this.var_308.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_45 || _loc4_.status == QuestStatusEnum.const_537))
            {
               _loc3_ = _loc4_;
            }
         }
         ...
         else if(this.var_367.length > 0)
         {
            this.activateListItem(this.var_367[0]);
         }
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_309 = new QuestView(this,param1);
         this.var_1194.addChild(this.var_309.view);
         this.var_309.init();
      }
