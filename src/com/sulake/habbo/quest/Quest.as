package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2615:uint = 2;
      
      private var var_2614:uint = 0;
      
      private var var_917:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1543 = param1.roomItemTypeName;
         this.var_1546 = param1.rewardCurrencyAmount;
         this.var_1862 = new Date();
         this.var_1862.setTime(param1.endDateTimeStamp);
         this.var_663 = param1.localizationCode;
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_62.code,this.var_663].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_200)
            {
               this.var_917.style = this.var_2614;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_200)
            {
               this.var_917.style = this.var_2615;
            }
         }
      }
