package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      {
         var _loc3_:QuestCampaign = this.var_153[param1];
         if(!_loc3_)
         {
            _loc3_ = new QuestCampaign(this,param1);
            this.var_153[param1] = _loc3_;
         }
         if(_loc3_)
         {
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_194.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      {
         if(this.var_645 != MODE_TABS)
         {
            this.var_645 = MODE_NO_TABS;
         }
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_153[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_153[param1] = _loc4_;
         }
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1103.addChild(this.var_292.window);
      ...
      public function openCampaigns(param1:Array, param2:Boolean = false) : void
      {
         ...
         this.var_645 = MODE_TABS;
         for each(_loc3_ in param1)
         {
            _loc4_ = this.var_153[_loc3_];
            if(!_loc4_)
            {
               _loc4_ = new QuestCampaign(this,_loc3_);
               this.var_153[_loc3_] = _loc4_;
            }
      ...
      private function updateTabs() : void
      {
         ...
         else if(this.var_153.getKeys().length > 0)
         {
            _loc1_ = this.var_153.getKeys()[0];
         }
         if(_loc1_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_194.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1103 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_153.getKeys())
         {
            _loc3_ = this.var_153[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc2_ = this.var_194.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_533) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_194.getQuestCampaign(param2.caption);
      }
   }
}
