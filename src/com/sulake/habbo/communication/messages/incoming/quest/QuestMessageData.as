package com.sulake.habbo.communication.messages.incoming.quest
{
   ...
   public class QuestMessageData
   {
      ...
      public function QuestMessageData(param1:IMessageDataWrapper)
      {
         ...
         this.var_663 = param1.readString();
         this._questBadgeAchievementTypeId = param1.readString();
         var _loc2_:String = "";
         var _loc3_:int = this.var_663.length - 1;
         while(_loc3_ > 0 && this.isNumber(this.var_663.charAt(_loc3_)))
         {
            _loc2_ = this.var_663.charAt(_loc3_) + _loc2_;
            _loc3_--;
         }
         if(_loc3_ > 0)
         {
            this.var_1544 = this.var_663.substring(0,_loc3_ + 1);
         }
         else
         {
            this.var_1544 = this.var_663;
         }
         this.var_2119 = uint(_loc2_);
      }
