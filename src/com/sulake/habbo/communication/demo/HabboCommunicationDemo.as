package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2107:PseudoRandom;
      ...
      private var var_205:HabboHotelView;
      
      private var var_1264:String = "";
      
      private const const_1669:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_542 = param1;
            this.var_49.initConnection(HabboConnectionType.const_242);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_99,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_49 && this.var_143 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_205 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_143.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_143.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_205.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_143.getKey("use.sso.ticket") == "1";
         this.var_542 = this.var_143.getKey("sso.ticket",null);
         this.var_1534 = this.var_143.getKey("flash.client.url","");
         this.var_2108 = this.var_143.getKey("external.variables.txt","");
         if(this.var_205 == null)
         {
            this.var_205 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_49.mode = HabboConnectionType.const_89;
            if(this.var_542)
            {
               this.var_49.initConnection(HabboConnectionType.const_242);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_49.mode = HabboConnectionType.const_1077;
            }
         }
         this.var_49.initConnection(HabboConnectionType.const_242);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2107 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_49.mode)
         {
            case HabboConnectionType.const_89:
               ...
               this.var_205.loadBannerImage(_loc7_ + "?token=" + this.var_1264,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1077:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1446:
               this.var_825 = this.generateRandomHexString(30);
               this.var_451 = new DiffieHellman(new BigInteger(this.var_143.getKey("connection.development.prime"),16),new BigInteger(this.var_143.getKey("connection.development.generator"),16));
               this.var_451.init(this.var_825);
               _loc8_ = this.var_451.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_451.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_451.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2107);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1534,this.var_2108));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1669,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_542 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_542);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1265)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_187);
         }
         if(param1.type == Event.CLOSE && !this.var_2106)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_451 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_451.init(_loc14_);
            _loc15_ = this.var_451.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_825 = _loc14_;
            }
