package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      public static const const_342:String = "success";
      ...
      private var var_1325:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String, param4:Boolean = true)
      {
         ...
         this.var_1326 = "http://" + param3 + "/client";
         if(!param4)
         {
            this.var_1325.init();
            this.var_1325.addEventListener(HabboWeb.const_254,this.requestClientURL);
         }
         else
         {
      ...
      {
         var _loc2_:String = this.var_1326;
         if(this._assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + this.var_1326);
         }
         var _loc3_:URLRequest = new URLRequest(this.var_1326);
         if(this._assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            this.var_1325.requestReAuthenticate();
         }
         else
         {
            try
            {
               ...
               this.var_2330 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               facebookData = /\"facebook.user\" : \"(.*?)\"/.exec(data);
               if(facebookData)
               {
                  this.var_2331 = Boolean(facebookData[1]);
               }
