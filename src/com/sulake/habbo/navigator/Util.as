package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1440:CutToWidth = new CutToWidth();
      
      private static var var_1439:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1440.beforeSearch(param2,param1,param3);
         binarySearch(var_1440,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1439.beforeSearch(param2,param1,param3);
         binarySearch(var_1439,param2.length - 1);
      }
