package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_438:IRoomSettingsCtrlOwner;
      ...
      private var var_640:ICheckBoxWindow;
      ...
      private var var_2688:ITextWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1922 = true;
         this.var_438.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_372 || this.var_1205 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1205 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1481)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1653)
         {
            this.var_1203.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1414)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1641)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_572,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_699,this.onDoorModePasswordUnselect);
         ...
         this.var_1203 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_1204 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1209 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1206 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_640 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1919 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1465 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1201 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1207 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1920 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1466 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_2688 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2689 = ITextWindow(this._window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1919.visible = this._inRoom;
         this.var_1920.visible = this._inRoom;
         this.var_2689.visible = this.var_521;
         this.var_2688.visible = !this.var_521;
         if(this.var_521)
         {
            this.var_1207.visible = true;
            this.var_1466.visible = false;
            this.refreshFlatControllers();
            this.var_1207.height = Util.getLowestPoint(this.var_1207) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1201.visible = true;
            this.var_1466.visible = true;
            this.var_1465.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1465.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1201.height = Util.getLowestPoint(this.var_1201) + 4;
         }
         this.var_1921.text = !!this.var_521 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1919.name,this.var_1465.name,this.var_1201.name,this.var_1207.name,this.var_1466.name,this.var_1920.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1203.setText(_loc1_.description);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1203.getText();
         ...
         _loc2_.allowPets = this.var_1204.isSelected;
         _loc2_.allowFoodConsume = this.var_1209.isSelected;
         _loc2_.allowWalkThrough = this.var_1206.isSelected;
         _loc2_.hideWalls = this.var_640.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_884,_loc2_.tags);
         this.addTag(this.var_885,_loc2_.tags);
         this.clearErrors();
         this.var_1205 = _loc2_.roomId;
