package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_950:int = 32;
      
      private static const const_1324:int = 8;
      
      private static const const_1323:int = -16;
      
      private static const const_1322:int = 40;
       
      
      private var _navigator:HabboNavigator;
      
      private var var_2552:Dictionary;
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_950 / 2);
         return new Point(param1 * const_950 + _loc3_,param2 * const_1324);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_295,HabboWindowStyle.const_42,0 | (!!param3 ? HabboWindowParam.const_38 : HabboWindowParam.const_42),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_948.getImage(ThumbnailEditorModel.const_58,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1416 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1416,this.var_1416.rect,new Point(0,0),null,null,true);
      }
      
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_948.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1323,_loc4_.y + const_1322 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2552[param1]);
      }
   }
}
