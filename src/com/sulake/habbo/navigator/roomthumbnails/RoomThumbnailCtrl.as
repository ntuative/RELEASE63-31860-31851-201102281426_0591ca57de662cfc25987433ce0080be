package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2617:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1869 = IButtonWindow(this.find("bg_tab"));
         this.var_1868 = IButtonWindow(this.find("top_tab"));
         this.var_1867 = IButtonWindow(this.find("obj_tab"));
         this.var_2617 = IWindowContainer(this.find("tile_grid"));
         this.var_2618 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1869,this.onBgTabButton);
         Util.setProcDirectly(this.var_1868,this.onTopTabButton);
         Util.setProcDirectly(this.var_1867,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_65.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1869,this.var_65.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1868,this.var_65.mode != ThumbnailEditorModel.const_58);
         this.setEnabled(this.var_1867,this.var_65.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2618;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_65.mode == ThumbnailEditorModel.const_36);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2617;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_295,HabboWindowStyle.const_42,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
