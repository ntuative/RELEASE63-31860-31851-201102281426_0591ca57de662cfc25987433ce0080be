package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2390:ITextWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2390.text = this._navigator.getText("roomevent_type_" + param1.eventType);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2390 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1701 = ITextWindow(this.find("create_caption"));
            this.var_1703 = ITextWindow(this.find("edit_caption"));
            this.var_1350 = IButtonWindow(this.find("create_button"));
            this.var_1348 = IButtonWindow(this.find("edit_button"));
            this.var_2389 = IButtonWindow(this.find("cancel_button"));
            this.var_1349 = IButtonWindow(this.find("end_button"));
            this.var_883 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1350,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1348,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1349,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2389,this.onCancelButtonClick);
