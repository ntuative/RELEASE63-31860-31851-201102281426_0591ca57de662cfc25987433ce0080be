package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_591:RoomInfoViewCtrl;
      
      private var var_1092:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_428:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2817:Dictionary;
      ...
      private var var_2256:RoomThumbnailRenderer;
      
      private var var_980:GuestRoomPasswordInput;
      
      private var var_294:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_591 = new RoomInfoViewCtrl(this);
         this.var_1092 = new RoomCreateViewCtrl(this);
         this.var_2256 = new RoomThumbnailRenderer(this);
         this.var_980 = new GuestRoomPasswordInput(this);
         this.var_294 = new GuestRoomDoorbell(this);
         this.var_428 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_295,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_591.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_172.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_289.startSearch(Tabs.const_243,Tabs.const_392,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_289.startSearch(Tabs.const_320,Tabs.const_261);
         this.var_428.getTab(Tabs.const_320).tabPageDecorator.tabSelected();
      }
