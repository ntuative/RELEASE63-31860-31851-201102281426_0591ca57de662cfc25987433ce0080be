package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_531:IScrollbarWindow;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_531 = IScrollbarWindow(this.var_176.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_531.scrollV = 0;
         }
         this.var_176.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_56.numListItems)
         {
            if(this.var_56.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_56.getListItemAt(param2));
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_511.visible && this.var_2627)
            {
               return;
            }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1444.tags[0];
            this.var_1444.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2626 - _loc2_.stageX);
         this.var_2626 = _loc2_.stageX;
