package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1067:int = 4;
      
      private static const const_944:int = 1;
      
      private static const const_599:int = 2;
      
      private static const const_945:int = 3;
      ...
      private var var_935:PopularTagsListCtrl;
      
      private var var_936:GuestRoomListCtrl;
      
      private var var_1126:OfficialRoomListCtrl;
      ...
      private var var_1407:IWindow;
      
      private var var_1128:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_935 = new PopularTagsListCtrl(this._navigator);
         this.var_936 = new GuestRoomListCtrl(this._navigator);
         this.var_1126 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_259 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_259)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_176 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         ...
         this.var_254 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1407 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1128 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1128)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1128.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_827,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1626,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_176,["custom_content","list_content"],this.var_223.y,8);
         this.var_196.height = this.var_196.height + _loc1_ - this.var_196.y - this.var_254.height + this.var_2524;
         Util.moveChildrenToColumn(this.var_176,["list_content","custom_footer"],this.var_196.y,0);
         this.var_2524 = this.var_254.height;
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_254);
         if(Util.hasVisibleChildren(this.var_254))
         {
      ...
      {
         this.refreshList(param1,param2,this.var_936,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_935,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1126,"official_rooms");
      }
      ...
      public function startSearch(param1:int, param2:int, param3:String = "-1", param4:int = 1) : void
      {
         ...
         {
            this.open();
            this.var_607 = const_599;
            this.var_196.blend = 0;
            if(this.var_223.visible)
            {
               this.var_223.blend = 0;
               this.var_254.blend = 0;
            }
         }
         else
         {
            this.var_607 = const_944;
         }
         this.var_1408 = 0;
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_607 == const_944)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_196.blend - _loc2_));
            this.var_196.blend = _loc3_;
            this.var_223.blend = !!this.var_1127 ? Number(_loc3_) : Number(1);
            this.var_254.blend = !!this.var_1127 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_607 = const_599;
            }
         }
         else if(this.var_607 == const_599)
         {
            if(this.var_1408 % 10 == 1)
            {
               this.var_1407.visible = !this.var_1407.visible;
            }
            ++this.var_1408;
            if(!this._navigator.data.isLoading())
            {
               this.var_607 = const_945;
            }
         }
         else if(this.var_607 == const_945)
         {
            this.refresh();
            this.var_607 = const_1319;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_935);
      ...
      {
         this._navigator.refreshButton(this.var_1128,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1128,"icon_hotelview_reactive",param1,null,0);
      }
