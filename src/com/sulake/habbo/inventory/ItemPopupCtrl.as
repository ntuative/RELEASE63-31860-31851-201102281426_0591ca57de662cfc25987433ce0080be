package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_939:int = 5;
      
      private static const const_1314:int = 250;
      
      private static const const_1313:int = 100;
      
      private static const const_1311:int = 180;
      ...
      public function ItemPopupCtrl(param1:IWindowContainer, param2:IAssetLibrary)
      {
         ...
         this.var_351 = new Timer(const_1313,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         {
            this.var_925 = _loc3_.content as BitmapData;
         }
         _loc3_ = this._assets.getAssetByName("popup_arrow_left_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_732 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1311,param3.width),Math.min(const_1312,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1772);
         switch(this.var_1772)
         {
            case const_1146:
               this.var_77.x = -1 * this.var_77.width - const_939;
               break;
            case const_530:
               this.var_77.x = this._parent.width + const_939;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1146:
               _loc2_.bitmap = this.var_925.clone();
               _loc2_.width = this.var_925.width;
               _loc2_.height = this.var_925.height;
               _loc2_.y = (this.var_77.height - this.var_925.height) / 2;
               _loc2_.x = this.var_77.width - 1;
               break;
            case const_530:
               _loc2_.bitmap = this.var_732.clone();
               _loc2_.width = this.var_732.width;
               _loc2_.height = this.var_732.height;
               _loc2_.y = (this.var_77.height - this.var_732.height) / 2;
               _loc2_.x = -1 * this.var_732.width + 1;
         }
         _loc2_.invalidate();
      }
