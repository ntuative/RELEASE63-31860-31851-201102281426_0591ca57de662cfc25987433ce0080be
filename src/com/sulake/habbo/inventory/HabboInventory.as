package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1153:IRoomSession;
      ...
      private const const_2001:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_99,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_468,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_52.getValue(InventoryCategory.const_73));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_52.getValue(InventorySubCategory.const_319));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_52.getValue(InventoryCategory.const_813));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_52.getValue(InventoryCategory.const_280));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_52.getValue(InventoryCategory.const_343));
      }
      ...
      {
         return PetsModel(this.var_52.getValue(InventoryCategory.const_149));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_52.getValue(InventoryCategory.const_390) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_99,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_468,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               this.var_1153 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_468:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_393 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_173)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_173);
         this.var_52 = new Map();
         ...
         this.var_52.add(InventoryCategory.const_390,_loc1_);
         ...
         this.var_52.add(InventoryCategory.const_813,_loc4_);
         ...
         this.var_52.add(InventoryCategory.const_343,_loc5_);
         ...
         this.var_52.add(InventorySubCategory.const_319,_loc6_);
         ...
         this.var_52.add(InventoryCategory.const_149,_loc8_);
         this.var_182 = true;
         if(this.var_2633)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_319:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_964.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_964.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_964.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_964.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2001);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_702));
      }
