package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_353:String = "pets";
      
      private static const const_1292:int = 100;
      ...
      private var var_1698:Vector.<Array>;
      
      private var var_1699:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_224,this.onObjectPlaced);
         this._catalog = param7;
         this.var_587 = new Timer(const_1292,1);
         this.var_587.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2386 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_224,this.onObjectPlaced);
               }
            ...
            {
               this.var_587.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_587.stop();
               this.var_587 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_43)
            {
               ...
               {
                  this.var_1698 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1698;
            }
            else
            {
               if(this.var_1699 == null)
               {
                  this.var_1699 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1699;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_73);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_381)
         {
         ...
         else if(param3 == FurniCategory.const_361)
         {
         ...
         if(this.var_881 == null)
         {
            this.var_881 = this._windowManager.buildFromXML(this.var_2386) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_881.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_73 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_50:
                  ...
                  break;
               case const_353:
                  this._controller.toggleInventoryPage(InventoryCategory.const_149);
            }
         }
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_586.add(const_43,new Array());
         this.var_586.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_157)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_319;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_361 || _loc3_.category == FurniCategory.const_381 || _loc3_.category == FurniCategory.const_367)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1345 && param1.type == RoomEngineObjectEvent.const_224)
         {
            this.var_1345 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_586.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_737)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
