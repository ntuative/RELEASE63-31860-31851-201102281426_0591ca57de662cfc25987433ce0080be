package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_802:int = 0;
      
      protected var var_650:BitmapData;
      
      protected var var_2483:int;
      
      protected var var_1488:Boolean;
      
      protected var var_1982:Boolean;
      
      protected var var_2746:BitmapData;
      
      private const const_1963:int = 8947848;
      
      private const const_1962:int = 13421772;
      
      private const const_1697:Number = 1;
      
      private const const_1696:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1975 = param8;
         this.var_1420 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1420));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1975);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_737)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1696;
               _loc1_.blend = this.const_1696;
            }
            else
            {
               this._window.blend = this.const_1697;
               _loc1_.blend = this.const_1697;
            }
         }
         if(this.isSelected)
         {
