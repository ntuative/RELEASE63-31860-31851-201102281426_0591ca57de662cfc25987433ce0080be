package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1970:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_922.length)
         {
            if(this.var_922[_loc2_] == param1)
            {
               this.var_922.splice(_loc2_,1);
      ...
      {
         if(param1 == InventoryCategory.const_280 && this._controller.isVisible)
         {
