package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_938:uint = 4284532064;
      
      private static const const_937:uint = 2577770;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1757 = this.createMinimizedWindow();
         }
         if(!this.var_2450)
         {
            return this.var_69;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_69)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_938) : uint(const_937);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_938) : uint(const_937);
            }
         ...
         if(this.var_69)
         {
            ...
            switch(this.var_21.state)
            {
               ...
               case TradingModel.const_380:
                  ...
                  break;
               case TradingModel.const_318:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_519:
                  _loc1_.disable();
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_157)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1108)
            {
            ...
            this.var_418.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_530);
            this.var_418.show();
         }
