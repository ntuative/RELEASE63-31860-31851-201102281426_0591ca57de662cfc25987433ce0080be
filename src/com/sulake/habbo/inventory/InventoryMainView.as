package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2786:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_173 != null && this.var_1114)
         {
            this.var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1114 = false;
         }
         this._controller.inventoryViewOpened(this.var_729);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_730 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_173 != null && this.var_1114)
            {
               this.var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1114 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_729);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1770);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_730 == InventoryCategory.const_149)
            {
               this.toggleCategoryView(InventoryCategory.const_149);
            }
            else if(this.var_730 == InventoryCategory.const_73)
            {
               this.toggleCategoryView(InventoryCategory.const_73);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_73);
            }
         }
      }
