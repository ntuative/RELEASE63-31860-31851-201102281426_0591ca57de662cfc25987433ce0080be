package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1678:Number = 15;
      
      private var var_1679:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_148 = this._window.width;
         this.var_216 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_62,HabboWindowStyle.const_1040,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1078 = _loc6_.toolbar.@margin_top;
         this.var_1338 = _loc6_.toolbar.@margin_bottom;
         this.var_1678 = _loc6_.toolbar.@min_group_margin;
         this.var_1679 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_312 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_243,param1,param2,this._window,this.var_312);
         this.createGroupsFromXmlList(_loc8_,this.var_579,param1,param2,this.var_216,this.var_312);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_148);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_148,this.var_476,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_476);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_148,this.var_476);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_148,this.var_476);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_579.length)
         {
            _loc2_ = this.var_579[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_216 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_216.x = this.var_148 + this.var_1679;
               this.var_216.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_148;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_148;
               this._window.y = 0;
               this.var_216.x = 0;
               this.var_216.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_148;
               this._window.x = 0;
               this._window.y = 0;
               this.var_216.x = 0;
               this.var_216.y = this.var_148 + this.var_1679;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_148;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_148;
               this.var_216.x = 0;
               this.var_216.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1338;
         _loc4_ -= this.var_1078;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1078;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_243.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1678,(this._window.height - _loc5_ * _loc8_ - this.var_1078 - this.var_1338) / (this.var_243.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1678,(this._window.width - _loc5_ * _loc8_ - this.var_1078 - this.var_1338) / (this.var_243.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_243.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_476;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_579.length)
         {
            _loc3_ = this.var_579[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_148)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_148)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_148)
         {
            return "BOTTOM";
         }
         return null;
