package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_209:Boolean = true;
      
      private static const const_1248:Number = 25;
      
      private static const const_1249:Number = 90;
      
      private static const const_951:int = 50;
      
      private static const const_1325:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1419:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_614 = new Object();
         this.var_615 = new Array();
         this.var_616 = new Array();
         super();
         this._windowManager = param1;
         this.var_1419 = param2;
         this.var_748 = new Timer(const_1248);
         this.var_748.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_951 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_951 || param1.desktop.height - param1.y < const_1325;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1419.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1419.getIconLoc(param1.iconId);
      ...
      {
         return this.var_615[this.var_616.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_616[this.var_615.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_616.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_616.splice(_loc3_,1);
            this.var_615.splice(_loc3_,1);
         }
         this.var_615.push(param1.name);
         this.var_616.push(param2);
         param1.addEventListener(WindowEvent.const_338,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_219,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_614[_loc3_] == null)
            {
               this.var_614[_loc3_] = new Array();
            }
            if(this.var_614[_loc3_].indexOf(param1) < 0)
            {
               this.var_614[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_615[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_616[_loc2_];
               if(this.var_614[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_614[_loc3_].length)
                  {
                     this.repositionWindow(this.var_614[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
