package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_172 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1539 = int(this.var_172.getKey("latencytest.interval"));
         this.var_1540 = int(this.var_172.getKey("latencytest.report.index"));
         this.var_2111 = int(this.var_172.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1537 > this.var_1539)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1537 = getTimer();
         this.var_547.add(this.var_1268,this.var_1537);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1268));
         ++this.var_1268;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_547 == null || this.var_207 == null)
         {
            return;
         }
         ...
         if(this.var_207.length == this.var_1540 && this.var_1540 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1538) > this.var_2111 || this.var_1538 == 0)
            {
               this.var_1538 = _loc9_;
