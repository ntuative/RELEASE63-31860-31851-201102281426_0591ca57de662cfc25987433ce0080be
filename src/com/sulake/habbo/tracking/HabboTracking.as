package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_191:IHabboFriendList;
      
      private var var_1101:IHabboWindowManager;
      ...
      private var var_594:FramerateTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1561,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1368,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1579,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_723,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1140,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1101)
            {
               this.var_1101.release(new IIDHabboWindowManager());
               this.var_1101 = null;
            }
            if(this.var_287)
            {
            ...
            if(this.var_191)
            {
               ...
               {
                  Component(this.var_191).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_191).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_191).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_191).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_191).events.removeEventListener(HabboFriendListTrackingEvent.const_366,this.onFriendlistTrackingEvent);
               }
               this.var_191.release(new IIDHabboFriendList());
               this.var_191 = null;
            }
            if(this.var_177)
            {
            ...
            if(this.var_173)
            {
               if(!this.var_173.disposed)
               {
                  this.var_173.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
      ...
      {
         this.var_1383[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_172 = IHabboConfigurationManager(param2);
         if(this.var_172)
         {
            if(this.var_247 != null)
            {
               this.var_247.configuration = this.var_172;
            }
            if(this.var_246 != null)
            {
               this.var_246.configuration = this.var_172;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1488);
            if(this.var_172)
            {
               if(this.var_596 != null)
               {
                  this.var_596.configure(this.var_172);
               }
               if(this.var_594 != null)
               {
                  this.var_594.configure(this.var_172);
               }
               if(this.var_595 != null)
               {
                  this.var_595.configure(this.var_172);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_168);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_187,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_425,this.onHotelViewEvent);
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1532);
         }
         else if(param1.type == HabboHotelViewEvent.const_425)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1493);
         }
         else if(param1.type == HabboHotelViewEvent.const_68)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1603);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1655);
               break;
            case HabboCommunicationEvent.const_763:
               this.trackLoginStep(HabboLoginTrackingStep.const_1593,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_270:
               this.trackLoginStep(HabboLoginTrackingStep.const_270);
               break;
            case HabboCommunicationEvent.const_187:
               this.trackLoginStep(HabboLoginTrackingStep.const_187);
               break;
      ...
      {
         this.var_1101 = IHabboWindowManager(param2);
         if(this.var_1101)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_172)
            {
               if(this.var_172.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_172.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1383)
                  {
                  ...
                  if(this.var_246 != null)
                  {
                     ...
                     _loc4_["null"] = this.var_246.method_11;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1013);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1013,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_191 = param2 as IHabboFriendList;
         Component(this.var_191).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_191).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_191).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_191).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_191).events.addEventListener(HabboFriendListTrackingEvent.const_366,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_366:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1140,String(_loc2_.guestRoomId));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_287.events.addEventListener(AdEvent.const_542,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_173 = param2 as IHabboToolbar;
         this.var_173.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
      ...
      {
         if(this.var_172 != null && !Boolean(this.var_172.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1749;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1749);
         }
         if(this.var_483 > -1 && _loc2_ - this.var_483 > 15000)
         {
            ++this.var_1748;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1748);
         }
         this.var_483 = _loc2_;
         if(this.var_246 != null)
         {
            this.var_246.update(param1,this.var_483);
         }
         if(this.var_247 != null)
         {
            this.var_247.update(param1,this.var_483);
         }
         if(this.var_594 != null)
         {
            this.var_594.trackUpdate(param1,this,this.var_483);
         }
         if(this.var_596 != null)
         {
            this.var_596.update(this.var_483);
         }
      }
   }
}
