package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_942:int = 3600;
      
      private static const const_941:int = 86400;
      
      private static const const_940:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_941)
         {
            return Math.round(param1 / const_942) + " hours ago";
         }
         if(param1 < 2 * const_940)
         {
            return Math.round(param1 / const_941) + " days ago";
         }
         return Math.round(param1 / const_940) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1115.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1115.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1138,this._data.userId),this._callerFrame,this.var_1116,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1116,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1352),this._callerFrame,this.var_1116,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1352),this._callerFrame,this.var_1116,false,true);
      }
