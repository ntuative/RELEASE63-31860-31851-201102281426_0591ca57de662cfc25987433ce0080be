package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_514:UserInfoCtrl;
      
      private var var_1187:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_514 = new UserInfoCtrl(this._window,this.var_63,_loc3_.message);
         this.var_1187 = new UserInfoCtrl(this._window,this.var_63,_loc3_.message);
         this.var_514.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1187.load(_loc4_,this.var_162.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_63 != null && this.var_63.issueManager != null && this.var_162 != null)
         {
            this.var_63.issueManager.removeHandler(this.var_162.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_63.issueManager.closeBundle(this.var_162.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_63.issueManager.closeBundle(this.var_162.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_63.issueManager.closeBundle(this.var_162.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_63.issueManager.releaseBundle(this.var_162.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_63,WindowTracker.const_1162,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_514 = new UserInfoCtrl(this._window,this.var_63,_loc3_.message);
            this.var_514.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
