package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1999:String = "my_issues";
      
      private const const_2000:String = "open_issues";
      
      private const const_1998:String = "picked_issues";
      
      private const const_2006:String = "closed_issues";
      ...
      private var var_1875:IIssueBrowserView;
      
      private var var_1874:IIssueBrowserView;
      
      private var var_1873:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_259 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_259.numTabItems)
            {
               _loc5_ = this.var_259.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_259 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_259 == null || this.var_259.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_259.selector.getSelectableByName("open_issues");
         this.var_259.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_362.view.width = this.var_259.container.width;
         this.var_362.view.height = this.var_259.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1999:
               ...
               {
                  this.var_1875 = new MyIssuesView(this.issueManager,this,this.var_259.container);
               }
               return this.var_1875;
            case this.const_2000:
               if(this.var_1874 == null)
               {
                  this.var_1874 = new OpenIssuesView(this.issueManager,this,this.var_259.container);
               }
               return this.var_1874;
            case this.const_1998:
               if(this.var_1873 == null)
               {
                  this.var_1873 = new PickedIssuesView(this.issueManager,this,this.var_259.container);
               }
