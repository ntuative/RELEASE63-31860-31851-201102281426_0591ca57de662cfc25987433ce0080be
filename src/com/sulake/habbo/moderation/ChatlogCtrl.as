package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_898:Array = [];
      
      private static var var_1720:int = 1000;
      
      private static var var_899:Array = [];
      
      private static var var_1723:int = 200;
      ...
      private var var_1721:IMessageComposer;
      ...
      {
         this.var_711 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_712 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_454 = new Timer(1000,1);
         ...
         this.var_56 = IItemListWindow(this._frame.findChildByName("chatline_list"));
         this._frame.procedure = this.onWindow;
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_34.connection.send(this.var_1721);
      ...
      {
         var _loc1_:* = null;
         this.var_56.autoArrangeItems = false;
         for each(_loc1_ in this.var_115)
         {
            this.populateRoomChat(_loc1_);
         }
         this.var_56.autoArrangeItems = true;
      }
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.addHeaderLineToList(_loc2_,this.var_56);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            this.populateChatline(this.var_56,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_898.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_712.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_898.length < var_1720)
         {
            ...
            param1.width = this.var_712.width;
            param1.height = this.var_712.height;
            var_898.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_899.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_711.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_899.length < var_1723)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_711.width;
            param1.height = this.var_711.height;
            var_899.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1722[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1367.getValue(param2.chatterName))
            {
               this.var_1367.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1367.getValue(_loc2_);
      ...
      private function refreshListDims() : void
      {
         ...
         var _loc2_:* = null;
         this.var_56.autoArrangeItems = false;
         var _loc3_:int = this.var_56.numListItems;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = IWindowContainer(this.var_56.getListItemAt(_loc4_));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_56.parent);
         var _loc2_:IWindow = _loc1_.getChildByName("scroller") as IWindow;
         var _loc3_:* = this.var_56.scrollableRegion.height > this.var_56.height;
         if(_loc2_.visible)
         {
            if(_loc3_)
            {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1366)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1365)
         {
