package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_56:IItemListWindow;
      
      private var _disposed:Boolean;
      
      private var var_1181:IDropMenuWindow;
      
      private var var_477:ITextFieldWindow;
      
      private var var_537:Boolean = true;
      
      private var var_967:ICheckBoxWindow;
      
      private var var_1451:ICheckBoxWindow;
      
      private var var_1452:ICheckBoxWindow;
      ...
      {
         this.var_56 = IItemListWindow(this._frame.findChildByName("list_cont"));
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_477 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_477.procedure = this.onInputClick;
         this.var_1181 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1181);
         this.var_1181.procedure = this.onSelectTemplate;
         this.var_967 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1451 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1452 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_56.getListItemByName(param2));
         ...
         if(!param1.exists)
         {
            this.disposeItemFromList(this.var_56,_loc3_);
            this.disposeItemFromList(this.var_56,this.var_56.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_884,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_537 || this.var_477.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_967.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1402,_loc2_,this.var_477.text,"",""));
         if(this.var_1451.isSelected || this.var_1452.isSelected || this.var_967.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1451.isSelected,this.var_1452.isSelected,this.var_967.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1535);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1181.selection];
         if(_loc3_ != null)
         {
            this.var_537 = false;
            this.var_477.text = _loc3_;
         }
      }
   }
}
