package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_744:IssueMessageData = null;
      
      private var var_745:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2071 = param2.pickerUserId;
         this.var_2542 = param2.pickerUserName;
         this.var_1287 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_744 == null || param1.timeStamp < this.var_744.timeStamp)
         {
            this.var_744 = param1;
         }
         if(this.var_745 == null || param1.priority > this.var_745.timeStamp)
         {
            this.var_745 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_745;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_744;
         if(_loc2_ == null)
         {
