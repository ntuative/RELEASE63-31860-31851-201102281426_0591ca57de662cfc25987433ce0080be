package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1542:int = 200;
      ...
      {
         this.var_662 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
         ...
         this.var_56 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1531;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_56);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_662.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_831.length < var_1542)
         {
            ...
            param1.width = this.var_662.width;
            param1.height = this.var_662.height;
            var_831.push(param1);
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_56.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_56.scrollableRegion.height > this.var_56.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_56.width += 17;
            }
         }
         else if(_loc4_)
         {
