package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1428:String = "normal_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1428:
               ...
               {
                  _loc5_ = this.var_172.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1211:
               if(this.var_172 != null)
               {
                  if(this.var_172 != null)
                  {
                     _loc5_ = this.var_172.getKey("group.badge.url");
