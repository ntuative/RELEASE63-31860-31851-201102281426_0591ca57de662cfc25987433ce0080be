package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_926:ConversationsTabView;
      
      private var var_862:ITextFieldWindow;
      
      private var var_16:IFrameWindow;
      
      private var var_1397:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_16 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_129.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MESSENGER,this.var_16));
         }
         else
         {
            this.refresh();
      ...
      public function refresh() : void
      {
         ...
         this.var_926.refresh();
         this.var_1397.refresh();
         if(this.var_129.conversations.openConversations.length < 1)
         {
            this.var_16.visible = false;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1397.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_926 = new ConversationsTabView(this.var_129,this.var_16);
         this.var_926.refresh();
         this.var_862 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_862.addEventListener(WindowKeyboardEvent.const_196,this.onMessageInput);
         this.var_1397 = new ConversationView(this.var_129,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_827,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1083,true);
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_862.text = "";
         this.var_129.conversations.addMessageAndUpdateView(new Message(Message.const_782,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_926 == null ? 7 : int(this.var_926.getTabCount());
      }
   }
}
