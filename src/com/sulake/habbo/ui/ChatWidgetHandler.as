package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_673:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_282 != null)
         {
            ...
            {
               _loc2_ = this.var_282.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1028)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_707,RoomWidgetChatSelectAvatarMessage.const_726];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_707:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_991))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_991))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_726:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_199)
                           {
                              _loc13_ = this.var_282.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_390.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_553.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_199:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_49);
                                          _loc18_ = _loc17_.getPartColor("ch");
                                          _loc17_.dispose();
                                          if(_loc18_ != null)
                                          {
                                             _loc12_ = uint(_loc18_.rgb);
                                             this.var_553.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_199)
                                    {
                                       this.var_282.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1029 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1029);
            }
            if(this.var_673 == null)
            {
               ...
               this.var_462.y = 0;
               this.var_462.z = 0;
               this.var_673 = _loc4_.getScreenPoint(this.var_462);
               this.var_1029 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_462.x = 0;
            this.var_462.y = 0;
            this.var_462.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_462);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_673.x || _loc8_.y != this.var_673.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_673,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_282)
         {
            _loc2_ = this.var_282.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1028.push(_loc2_);
            }
         }
      }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_553.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1581.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1581.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_282)
            {
               this.var_282.add(_loc3_,param2);
            }
         }
      }
   }
