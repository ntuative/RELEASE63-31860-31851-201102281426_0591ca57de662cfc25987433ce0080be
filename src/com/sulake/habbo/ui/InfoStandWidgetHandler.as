   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_165,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_130,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_165,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_130,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_337);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_299);
         _loc1_.push(RoomWidgetFurniActionMessage.const_728);
         _loc1_.push(RoomWidgetFurniActionMessage.const_735);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_646);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_731);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_816);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1652);
         _loc1_.push(RoomWidgetPetCommandMessage.const_498);
         _loc1_.push(RoomWidgetPetCommandMessage.const_806);
         _loc1_.push(RoomWidgetUserActionMessage.const_497);
         _loc1_.push(RoomWidgetUserActionMessage.const_403);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_759);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_461)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_403 || param1.type == RoomWidgetUserActionMessage.const_497 || param1.type == RoomWidgetUserActionMessage.const_506)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_337:
            ...
            case RoomWidgetUserActionMessage.const_644:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1167,_loc3_.name);
            ...
            case RoomWidgetRoomTagSearchMessage.const_646:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_731:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_816:
            ...
            case RoomWidgetUserActionMessage.const_655:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_806:
            ...
            case RoomWidgetPetCommandMessage.const_498:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_759:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_388);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1073);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1172);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_199)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_692)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_531);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_110)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_129)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_739);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1144;
                  }
                  if(!_loc28_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1568);
               }
               else
               {
