package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1265:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_767,RoomWidgetPresentOpenMessage.const_166,RoomWidgetPresentOpenedMessage.const_1467];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_767:
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_166:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_82:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_457,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_95)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_574,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_207)
                           {
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1265)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_396:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_575,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
