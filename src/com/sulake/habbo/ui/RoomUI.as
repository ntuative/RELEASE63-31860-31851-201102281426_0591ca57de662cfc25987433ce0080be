package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1068:IRoomWidgetFactory;
      
      private var var_393:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_490:IAvatarRenderManager;
      ...
      private var var_1069:IHabboHelp;
      ...
      {
         this.var_1329 = RoomDesktop.const_576;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1068.release(new IIDHabboRoomWidget());
            this.var_1068 = null;
         }
         ...
         {
            this.var_490.release(new IIDAvatarRenderManager());
            this.var_490 = null;
         }
         ...
         {
            this.var_1069.release(new IIDHabboHelp());
            this.var_1069 = null;
         }
         ...
         {
            this.var_868.release(new IIDHabboModeration());
            this.var_868 = null;
         }
         ...
         if(this.var_1067)
         {
            this.var_1067.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1067 = null;
         }
         this.var_1665 = null;
         ...
         if(this.var_286)
         {
            ...
            {
               _loc1_ = this.var_286.getKey(0) as String;
               _loc2_ = this.var_286.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1068 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_490 = param2 as IAvatarRenderManager;
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_173 = param2 as IHabboToolbar;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1665 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_287.events.addEventListener(AdEvent.const_433,this.adEventHandler);
            this.var_287.events.addEventListener(AdEvent.const_479,this.adEventHandler);
            this.var_287.events.addEventListener(AdEvent.const_542,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1069 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_868 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_868);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_475,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_128,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_463,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_484,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_496,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_507,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1017,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1112,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_611,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_173,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_890,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_828,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_563,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_485,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               if(param1.session != null)
               {
                  ...
                  this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.ZOOM));
                  this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.MEMENU));
                  this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_611:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_890:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_828:
      ...
      {
         this.var_1067 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_659,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_629,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_841,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_440,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_508,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_224,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_696,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_466,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_476 || param1.type == RoomEngineEvent.const_440)
         {
            ...
            case RoomEngineEvent.const_629:
               ...
               if(this._roomEngine != null)
               {
                  ...
                  if(!this._roomEngine.isPublicRoomWorldType(this._roomEngine.getWorldType(param1.roomId,param1.roomCategory)))
                  {
                     ...
                     _loc7_.iconState = "2";
                     this.var_173.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_845);
               ...
               if(this.var_1329 != RoomDesktop.const_576)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_326,this.var_1329);
               }
               if(this.var_287 != null)
               {
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1068;
         _loc3_.sessionDataManager = this.var_393;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_490;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_173;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1665;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_287;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1069;
         _loc3_.moderation = this.var_868;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_550;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1067;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_836);
         _loc3_.init();
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_286.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_326);
            if(_loc3_ != RoomDesktop.const_576)
            {
               this.var_1329 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
      ...
      {
         return this.var_286.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_286.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
