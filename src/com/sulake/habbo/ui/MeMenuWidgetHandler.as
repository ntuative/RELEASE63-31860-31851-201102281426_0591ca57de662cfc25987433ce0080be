   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_284,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_702,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_771,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_173 != null)
            {
               this.var_173.events.removeEventListener(HabboToolbarEvent.const_66,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_578,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_284,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_702,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_771,this.onHabboClubSubscriptionChanged);
         }
         this.var_173 = this._container.toolbar;
         if(this.var_173 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_578,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1320)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc4_.setDirection(AvatarSetType.const_49,3);
                  _loc1_ = _loc4_.getCroppedImage(AvatarSetType.const_49);
                  _loc4_.dispose();
               }
               this.var_1320 = _loc2_;
               this.var_1638 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1638;
            }
         }
         if(this.var_173 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1052,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_173.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_856);
         _loc1_.push(RoomWidgetDanceMessage.const_761);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_619);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_799);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_628);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_688);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_666);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_334);
         _loc1_.push(RoomWidgetStopEffectMessage.const_690);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1542);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1197);
         _loc1_.push(RoomWidgetToolbarMessage.const_642);
         _loc1_.push(RoomWidgetToolbarMessage.const_727);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_333);
         ...
         _loc1_.push(RoomWidgetGetSettingsMessage.const_843);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1526);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_808);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_746);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_882);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_725:
               ...
               break;
            case RoomWidgetWaveMessage.const_856:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_761:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_619:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_799:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_628:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_334:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1003)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_172,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_666:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_990:
                        this._catalog.openCatalogPage(CatalogPageName.const_1373,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1154:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_280);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1612:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_73);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1648:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_690:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_683:
               ...
               break;
            case RoomWidgetToolbarMessage.const_642:
               ...
               if(this.var_173)
               {
                  this.var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_727:
               ...
               {
                  this.var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_445,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_333:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_456));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_843:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_374,this._container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_746:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_374,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_882:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_566));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_357:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_764));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_754));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_578:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_505));
         }
      }
