package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2190 = this._config.getKey("interstitial.enabled","QuestVendingWallItemMessageComposer") == "true";
         this.var_2189 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2191 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1589 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1030 == 0)
         {
            this.var_1030 = getTimer();
            return false;
         }
         if(this.var_1589 > 0 && this.var_1588 >= this.var_1589)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1030;
         if(_loc1_ > this.var_2189)
         {
            ++this.var_1588;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1284 = _loc2_.imageUrl;
         this.var_2192 = _loc2_.clickUrl;
         this.var_1030 = getTimer();
         if(this.var_1284 != "")
         {
            _loc3_ = this.var_1284;
            ...
            {
               this.var_212 = new Timer(this.var_2191,1);
            ...
            this.var_212.start();
            _loc4_ = new URLRequest(this.var_1284);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_479,0,0,param1.bitmapData,this.var_2192));
            this.var_1030 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1285 = _loc2_.imageUrl;
         this.var_1587 = _loc2_.clickUrl;
         if(this.var_1285 != "" && this.var_1587 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1285);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_542,0,0,_loc4_,this.var_1587,this.var_1031,this.var_1032));
         }
      }
