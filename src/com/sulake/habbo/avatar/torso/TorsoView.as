   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_235,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_194,_windowManager,_assetLibrary);
         ...
         if(var_65 && var_134 == "")
         {
            var_65.switchCategory(FigureData.const_194);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_194);
                  break;
