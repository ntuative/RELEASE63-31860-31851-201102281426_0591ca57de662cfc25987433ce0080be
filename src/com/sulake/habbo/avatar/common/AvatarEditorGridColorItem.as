package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_822:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_622 = _loc4_.content as BitmapData;
         ...
         this.var_821 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_622.width,this.var_622.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_622,this.var_622.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_958.width,this.var_958.height,true,0);
            _loc5_ = this.var_958.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_822.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_821.width,this.var_821.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_821,this.var_821.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_822)
            {
               switch(this.var_822.clubLevel)
               {
                  case HabboClubLevelEnum.const_51:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_40:
                     _loc4_.style = HabboIconType.const_864;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_41:
                     _loc4_.style = HabboIconType.const_757;
                     _loc4_.visible = true;
               }
            }
            else
