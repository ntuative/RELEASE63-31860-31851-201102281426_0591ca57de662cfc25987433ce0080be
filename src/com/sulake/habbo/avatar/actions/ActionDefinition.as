package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1771:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1771 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2487 = parseInt(param1.@precedence);
         this.var_2488 = String(param1.@activepartset);
         this.var_2492 = String(param1.@assetpartdefinition);
         this.var_2491 = String(param1.@lay);
         this.var_784 = String(param1.@geometrytype);
         this.var_2374 = Boolean(parseInt(param1.@main));
         this.var_2490 = Boolean(parseInt(param1.@method_14));
         this.var_2489 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2486 = _loc6_;
            }
            else
            {
               this.var_1771[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_731.getValue(param1) == null)
         {
            this.var_731.add(param1,new Map());
         }
         var _loc4_:Map = this.var_731.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_731.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1771[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2486;
         }
         return _loc2_;
      }
