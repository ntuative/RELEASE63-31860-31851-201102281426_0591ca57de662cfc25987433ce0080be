package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1953:String = "hd-99999-99999";
      ...
      private var var_277:PetDataManager;
      ...
      private var var_1556:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_645 = RenderMode.const_1391;
         ...
         this.var_97.add(AvatarType.const_116,_loc4_);
         ...
         this.var_97.add(AvatarType.const_69,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_277 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         ...
         this.var_277.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_277.init();
         this.var_665.init();
         _loc2_ = this.var_97.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_97.getValue(AvatarType.const_69) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_97.getValue(AvatarType.const_116) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_172.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_209 == null)
               {
                  ...
                  _loc6_ = this.var_172.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_172.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_830)
         {
            if(this.var_2139 && this.var_2140 && this.var_2138)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_97.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1556)
         {
            this.var_1556 = new AvatarFigureContainer(this.const_1953);
         }
         this.var_209.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1556,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_278 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_278.getKeys())
         {
            _loc4_ = this.var_278.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_277.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1656)
         {
            _loc6_ = !this.var_277.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_277.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_97.getValue(AvatarType.const_69) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_278.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_277.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_97.getValue(AvatarType.const_69);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_278.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_278.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_97.getValue(AvatarType.const_116) as AvatarStructure;
      ...
      {
         return this.var_277 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_69:
               _loc3_ = this.var_97.getValue(AvatarType.const_69) as AvatarStructure;
               break;
            default:
