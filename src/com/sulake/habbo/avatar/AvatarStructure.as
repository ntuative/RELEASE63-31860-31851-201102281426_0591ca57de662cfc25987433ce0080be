package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_405:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_961:AvatarActionManager;
      
      private var var_360:FigureData;
      
      private var var_432:PartSetsData;
      
      private var var_293:AnimationData;
      ...
      private var var_1436:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_293 = new AnimationData();
         this.var_761 = new AnimationManager();
         this.var_508 = param2;
      ...
      {
         this.var_1436.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_961 = new AvatarActionManager(param1,this.var_508,param2);
         this.var_890 = this.var_961.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_508 == AvatarType.const_116)
            {
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_761.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_761.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_761.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_961.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_961.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_961.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_625[param1] = new Dictionary();
         }
         if(this.var_625[param1][param2])
         {
            return this.var_625[param1][param2];
         }
         this.var_625[param1][param2] = this.var_360.getMandatorySetTypeIds(param1,param2);
         return this.var_625[param1][param2];
      }
      ...
      {
         return this.var_961.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_761.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1369[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_293.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_761.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
      ...
      {
         return this.var_1436.getOffset(param1,param2,param3,param4,param5,param6);
      }
