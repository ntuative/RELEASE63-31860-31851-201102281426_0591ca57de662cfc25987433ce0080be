package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1650:Number = 1.0;
      
      private var var_1649:Number = 1.0;
      
      private var var_1651:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1046:Map;
      
      private var var_2228:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_1608 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2226 = parseInt(_loc2_,16);
         this.var_2227 = parseInt(_loc3_,16);
         ...
         this.var_1505 = new ColorTransform(this.var_1650,this.var_1649,this.var_1651,this._alphaMultiplier);
         this.var_1046 = this.generatePaletteMapForGrayscale(this.var_2227,this.var_2226);
      }
      ...
      {
         return this.var_1046.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1046.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1046.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1046.getValue("alphas") as Array;
      }
