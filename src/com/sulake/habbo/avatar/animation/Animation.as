package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1692:AvatarDataContainer;
      
      private var var_1341:Array;
      
      private var var_1691:DirectionDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1694 = String(param2.@desc);
         }
         else
         {
            this.var_1694 = this._id;
         }
         ...
         {
            this.var_1692 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_1691 = new DirectionDataContainer(param2.direction[0]);
         }
         ...
         if(param2.hasOwnProperty("remove"))
         {
            ...
            {
               this.var_1343.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_704.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("HabboRoomUICom_spec_top_right_png"))
         {
            this._overrideFrames = new Map();
            this.var_584 = new Map();
            for each(_loc7_ in param2.HabboRoomUICom_spec_top_right_png)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@HabboRoomUICom_spec_top_right_png;
               this.var_584.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_789,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_584.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_789)
            {
               _loc3_.push(_loc4_.id);
            }
            else if(_loc4_.type == AnimationLayerData.const_472)
            {
               for each(_loc5_ in this.var_704)
               {
      ...
      {
         return this.var_1343 != null;
      }
      
      public function hasAddData() : Boolean
      {
         return this.var_704 != null;
      }
