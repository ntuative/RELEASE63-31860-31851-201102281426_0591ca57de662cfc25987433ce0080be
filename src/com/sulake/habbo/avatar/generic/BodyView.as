package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_595:String = "tab_boy";
      
      private const const_594:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_65.controller.gender)
         {
            case FigureData.const_74:
               activateTab(this.const_595);
               inactivateTab(this.const_594);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_594);
               inactivateTab(this.const_595);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_595:
                  var_65.controller.gender = FigureData.const_74;
