package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1222:IWindowContainer;
      
      public static var var_1483:IWindowContainer;
      
      public static var var_1940:int = 6710886;
      ...
      private var var_2133:Boolean = true;
      
      private var var_1553:String;
      
      private var var_2132:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1020 = [];
         this.var_1275 = [AvatarEditorFigureCategory.const_653,AvatarEditorFigureCategory.const_49,AvatarEditorFigureCategory.const_264,AvatarEditorFigureCategory.const_612,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_103];
         super();
         ...
         if(var_1222 == null)
         {
            ...
            var_1222 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1483 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1483 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_388 = new Timer(1000);
         this.var_388.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1275;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_388.stop();
            this.var_388.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_388 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1275);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2133 = this.canChangeOutfit();
            this.var_388.stop();
            if(this._window)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1275;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1553 == AvatarEditorSideCategory.const_103 || this.var_2132))
         {
      ...
      {
         if(this.var_1553 == AvatarEditorSideCategory.const_103)
         {
            this.var_2132 = false;
            this.setSideContent(AvatarEditorSideCategory.const_777);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_777:
               break;
            case AvatarEditorSideCategory.const_432:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_432);
               break;
