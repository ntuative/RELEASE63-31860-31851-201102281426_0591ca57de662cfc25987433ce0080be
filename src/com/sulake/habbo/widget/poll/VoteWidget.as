package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1376:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_127,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_140,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_349,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_127,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_140,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_349,this.update);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(this.var_56.scrollableRegion.height - this.var_56.height,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_56 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_56 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         if(this._window == null || this.var_56 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_56.numListItems)
         {
            _loc2_ = this.var_56.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_1591)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2151;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_56.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_56.numListItems)
         {
            _loc4_ = this.var_56.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
