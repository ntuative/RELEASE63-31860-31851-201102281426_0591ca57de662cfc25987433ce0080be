package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1982:int = 152;
      
      private const const_1987:int = 16;
      
      private const const_1326:int = 4;
      
      private const const_1991:uint = 14342874;
      
      private const const_1983:uint = 3815994;
      
      private const const_1985:uint = 2085362;
      
      private const const_1989:uint = 39616;
      
      private const const_1994:uint = 10513106;
      
      private const const_1986:uint = 8734654;
      
      private const const_1990:uint = 9094430;
      
      private const const_1993:uint = 6200576;
      
      private const const_1992:String = "happiness";
      
      private const const_1984:String = "experience";
      
      private const const_1988:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1992,param1.nutrition,param1.nutritionMax,this.const_1989,this.const_1985);
         this.updateStateElement(this.const_1984,param1.experience,param1.experienceMax,this.const_1986,this.const_1994);
         this.updateStateElement(this.const_1988,param1.energy,param1.energyMax,this.const_1993,this.const_1990);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1982,this.const_1987,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1991);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1983);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_488) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_198.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_198.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_198.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_198.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_197 && this.var_197.getPetId() == this.var_488)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1406,true);
