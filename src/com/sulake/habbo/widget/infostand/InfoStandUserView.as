package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_151:IFrameWindow;
      
      private var var_588:IWindow;
      
      private var var_198:IBorderWindow;
      
      private var var_1060:TagListRenderer;
      
      private var var_125:IBorderWindow;
      
      private var var_2387:int;
      
      private const const_925:int = 5;
      
      private const const_1688:int = 39;
      
      private const const_1687:int = 7829367;
      
      private const const_1686:int = 16777215;
      
      private const const_1965:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1060 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_53 == null || this.var_198 == null || this.var_66 == null)
         {
            return;
         }
         this.var_66.width = this.var_66.scrollableRegion.width;
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_198.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_198.width,this.var_66.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_198.width < this.var_66.width)
         {
            this.var_198.x = this._window.width - this.var_198.width;
            this.var_66.x = 0;
         }
         else
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_198 = this._window.getListItemByName("info_border") as IBorderWindow;
         ...
         {
            this.var_53 = this.var_198.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_198.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_198.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_198.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_198.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_125.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_125.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_125.x = _loc5_.left - this.var_125.width;
         this.var_125.y = _loc5_.top + (_loc5_.height - this.var_125.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_125.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_125.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_125.x = _loc7_.left - this.var_125.width;
         this.var_125.y = _loc7_.top + (_loc7_.height - this.var_125.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_125 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_125 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_925;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_925;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1060.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1144:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2387 > this.const_1965 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2387 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1687;
      ...
      {
         this.var_151 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_151.center();
         this.var_151.procedure = this.badgesEventProc;
         this.var_151.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_151 && this.var_151.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_588 = null;
         var _loc2_:IItemGridWindow = this.var_151.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_151.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_151.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_588);
               }
               if(_loc3_ <= -1)
               {
                  return;
