package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_417:IFrameWindow;
      ...
      private const const_1968:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_349 = new Timer(this.const_1968);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1107.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_488);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1107.getValue(this.var_488) as CommandConfiguration;
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_806,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_39 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this.var_39 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         this.var_39.setParamFlag(WindowParam.const_98,true);
         this.var_39.context.getDesktopWindow().addEventListener(WindowEvent.const_48,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_417 == null)
         {
            ...
            this.var_417 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_417 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_417.x = 200;
            this.var_417.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_403,this.var_488));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_498,this.var_488,this.var_1755 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_498,this.var_488,this.var_1755 + " " + _loc5_);
