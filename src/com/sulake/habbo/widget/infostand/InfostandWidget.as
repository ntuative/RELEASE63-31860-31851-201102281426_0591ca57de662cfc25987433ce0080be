package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1683:String = "infostand_user_view";
      
      private const const_1680:String = "infostand_furni_view";
      
      private const const_1682:String = "infostand_pet_view";
      
      private const const_1681:String = "infostand_bot_view";
      ...
      private var var_1332:InfostandUserData;
      
      private var var_586:InfostandFurniData;
      ...
      private const const_1961:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1073 = new InfoStandFurniView(this,this.const_1680,this._catalog);
         this.var_123 = new InfoStandUserView(this,this.const_1683);
         this.var_338 = new InfoStandPetView(this,this.const_1682,this._catalog);
         this.var_404 = new InfoStandBotView(this,this.const_1681);
         this.var_1332 = new InfostandUserData();
         this.var_586 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_146 = new Timer(this.const_1961);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_407,this.onRoomObjectSelected);
         ...
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_165,this.onUserTags);
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_847,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_714,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_407,this.onRoomObjectSelected);
         ...
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_165,this.onUserTags);
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_847,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_714,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_403,this.var_338.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1683);
         if(this.var_146)
         {
            this.var_146.stop();
         }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_338.update(this.petData);
      ...
      {
         this.var_338.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_123.setTags(param1.tags,this.var_2344);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_146:
               _loc2_ = param1.id == this.var_586.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_167:
               if(this.var_123 != null && this.var_123.window != null && this.var_123.window.visible)
               {
                  _loc2_ = param1.id == this.var_1332.userRoomId;
                  break;
               }
               if(this.var_338 != null && this.var_338.window != null && this.var_338.window.visible)
               {
