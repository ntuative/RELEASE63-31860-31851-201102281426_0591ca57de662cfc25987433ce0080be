package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1699:int = 0;
      
      private const const_1702:int = 1;
      
      private const const_1701:int = 2;
      
      private const const_1703:int = 3;
      
      private const const_1698:int = 4;
      
      private const const_1979:int = 0;
      
      private const const_1972:int = 1;
      
      private const const_1973:int = 2;
      
      private const const_1976:int = 3;
      
      private const const_1978:int = 4;
      
      private const const_1977:int = 5;
      
      private const const_1700:String = "deco_img";
      
      private const const_1704:String = "dialog_bg";
      
      private const const_1974:String = "%campaign%_dialog_bg.png";
      
      private const const_332:String = "%campaign%_gift_package.png";
      
      private const const_1975:String = "%campaign%_gift_content.png";
      
      private const const_1971:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1396 = this.var_143.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1396 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1393.length)
         {
            _loc2_ = this.var_1393.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_143 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_568,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_775,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_630,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_568,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_568:
               _loc2_ = this.const_1699;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_630:
               ...
               if(_loc5_)
               {
                  ...
                  {
                     _loc2_ = this.const_1701;
                  }
               }
               else
               {
                  _loc2_ = this.const_1698;
               }
               this._shareId = null;
               this.var_1394 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_775:
               _loc2_ = this.const_1702;
         ...
         if(this._window && (this.var_1395 != _loc2_ || _loc3_ != this.var_174))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_174 = _loc3_;
         this.var_1395 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1395)
            {
               case this.const_1699:
                  ...
                  break;
               case this.const_1702:
                  if(this.var_378 == this.const_1979)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.locked");
                     _loc2_ = this.const_332;
                  }
                  else if(this.var_378 == this.const_1972)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.unlocked");
                     _loc2_ = this.const_1975;
                  }
                  else if(this.var_378 == this.const_1973)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.no_fb");
                     _loc3_ = var_79.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_79.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_332;
                  }
                  else if(this.var_378 == this.const_1976)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.not_enough_fb_friends");
                     _loc3_ = var_79.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_79.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_332;
                  }
                  else if(this.var_378 == this.const_1978)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_378 == this.const_1977)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1974.replace("%campaign%",this.var_174);
            this.setDecoImage(_loc5_,this.const_1704);
            _loc2_ = _loc2_.replace("%campaign%",this.var_174);
            this.setDecoImage(_loc2_,this.const_1700);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_686);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_174,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_174,"client.start_post",this._shareId);
         var _loc4_:String = this.var_143.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_174,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1394 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1394 == 1 ? "null" : InventoryCategory.const_149);
            }
         }
         this.sendConversionPoint("viral_" + this.var_174,"client.open_gift");
      }
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1393.push(new ImageDownloader(this,_assets,this.var_174,this.var_1396,param1,param2));
            return;
         }
      ...
      function onDecoImageReady(param1:ImageDownloader) : void
      {
         ...
         if(!this._window || this.var_174 != param1.campaignID)
         {
            return;
         }
