package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_964:String = "Boy";
      
      private static const const_965:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_383,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1036,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_383,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1036,this.onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_383:
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2096 = param1.objectCategory;
         ...
         _loc4_ = this._window.findChildByName(const_965);
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onGenderSelectionMouseEvent);
         }
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_760 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_153,true);
         this.var_760 = _loc4_;
         this.var_760.offset(100,100);
         var _loc6_:IWindow = this.var_760.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_357,param1,this.var_353,this.var_2096,this._roomId,this._roomCategory,_loc5_);
