package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1358:int = 11;
      
      private static const const_608:int = 18;
      
      private static const const_969:int = 16;
      
      private static const const_1359:int = 20;
      ...
      private var var_305:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1199 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2678 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_369 = new Timer(1000,1);
         this.var_369.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_436 = new Timer(10000,1);
         this.var_436.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_369.reset();
            this.var_369.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_369 = null;
         }
         if(this.var_436 != null)
         {
            this.var_436.reset();
            this.var_436.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_436 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc3_.method_1 = false;
         _loc4_.bitmap = _loc8_.content as BitmapData;
         _loc4_.method_1 = false;
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_608 + const_969;
         _loc1_.x = const_608;
         _loc1_.y = const_1358;
      }
      ...
      {
         this.var_305 = param1 - (const_608 + const_969);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1199 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_520 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1359);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_520.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_520 = _loc2_.text;
            if(!this.var_638)
            {
               this.var_638 = true;
               this.var_369.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_638);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_305)
         {
