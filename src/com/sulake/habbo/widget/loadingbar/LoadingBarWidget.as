package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_457:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_457.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_457 = null;
         }
         if(this.var_44 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_102,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_102,this.onShowLoadingBar);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_305,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_102,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_102,this.onShowLoadingBar);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_305,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_457 == null)
         {
            this.var_457 = new Sprite();
            this.var_457.addChild(new Bitmap(this.var_44));
            this.var_457.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_457.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_44;
            }
         }
         _loc2_.setDisplayObject(this.var_457);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_305)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1240 != "")
         {
            HabboWebTools.openWebPage(this.var_1240);
         }
      }
   }
}
