package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_1316:uint = 88200;
      
      private static const const_1315:uint = 88200;
      ...
      private var var_1400:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1777:TraxData;
      ...
      {
         this.var_1778 = uint(const_272 / 44.1);
         super();
         this._events = param4;
         this.var_2493 = param1;
         this.var_474 = 1;
         this.var_1400 = new Sound();
         ...
         this._length = 0;
         this.var_1401 = false;
         this.var_96 = new Vector.<Number>(const_272,true);
      }
      ...
      public function play() : Boolean
      {
         ...
         this.var_1401 = false;
         this.var_1400.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1400.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1400.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      {
         return Math.ceil(param1 / const_1316);
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1777.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1777.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1776.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         var _loc4_:* = [];
         var _loc5_:* = null;
         var _loc6_:int = this.var_733.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_.push(this.var_733[_loc7_].getKeys());
            _loc12_ = 0;
            ...
            _loc13_ = this.var_733[_loc7_].getWithIndex(_loc12_);
         ...
         while(_loc7_ >= 0)
         {
            ...
            while(_loc18_ < _loc17_)
            {
               ...
               if(_loc18_ < _loc17_)
               {
                  if(_loc16_ < this.var_733[_loc7_].length - 1)
                  {
                     _loc21_ = this.var_733[_loc7_].getWithIndex(++_loc16_);
                     if(_loc21_.id == 0)
                     {
                        _loc5_ = null;
                     }
         ...
         this.var_221 += const_272;
         if(this._soundChannel != null)
         {
            this.var_1778 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_221 > this._length + this.var_1778 * 44.1)
         {
            this.var_1401 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_889,this.var_2493));
      }
   }
}
