package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_576:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1157,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_877.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1031:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1451:
            ...
            this.var_877.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_172.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_172.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_577.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_701.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_701,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_875.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_875 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_172 == null || this._connection == null || this._roomEngine == null || this.var_576 != null)
         {
            return;
         }
         this.var_576 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_577.getValue(_loc2_);
         ...
         this.var_577.remove(_loc2_);
         this.var_701.add(_loc3_,_loc6_);
         if(this.var_577.length == 0 && this.var_700 != -1)
         {
            this.var_876.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1157,this.var_700));
            this.var_700 = -1;
            this.var_876 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_576.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1420,this.var_700));
         this.var_700 = -1;
         this.var_876 = null;
      }
      ...
      {
         this.var_474 = param1;
         this.var_576.updateVolume(this.var_474);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_94,HabboToolbarIconEnum.SOUNDS);
         _loc2_.iconState = !!param1 ? "1" : "0";
         this.var_173.events.dispatchEvent(_loc2_);
      }
   }
}
