package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_391:int = 100;
      ...
      {
         if(this.var_924 >= this.getPageCount())
         {
            this.var_924 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_220.length / const_391);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_924 * const_391;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_924 + 1) * const_391,this.var_220.length);
      }
