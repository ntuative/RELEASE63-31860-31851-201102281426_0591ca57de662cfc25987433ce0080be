package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_706:String = "bg";
      ...
      private var var_2557:IContainerButtonWindow;
      ...
      {
         this.var_2560 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2559 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2558 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2557 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_56.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_56.addListItem(_loc6_);
         }
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_706);
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_706);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2560,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2559,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2558,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2557,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_324)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_324 && _loc4_.online)
            {
