package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_781 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_781.procedure = this.onSearchInput;
         this.var_781.addEventListener(WindowKeyboardEvent.const_196,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_56.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_341,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_56.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_56.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_56.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_781.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_781.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
