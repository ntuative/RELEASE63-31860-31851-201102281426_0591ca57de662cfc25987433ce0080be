package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1675:String = "no_reqs_info";
      ...
      private var var_1630:IContainerButtonWindow;
      ...
      {
         this.var_1630 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1629 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1629.procedure = this.onDismissAllButtonClick;
         this.var_1630.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_371)
         {
         ...
         else if(param1.state == FriendRequest.const_1143)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_56.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_56.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_371;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_371 && _loc4_.state != FriendRequest.const_384)
            {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_371 && _loc4_.state != FriendRequest.const_384)
            {
               ...
               _loc4_.state = FriendRequest.const_371;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1630,_loc1_);
         this.setEnabled(this.var_1629,_loc1_);
      }
