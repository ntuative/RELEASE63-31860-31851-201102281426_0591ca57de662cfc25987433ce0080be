package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_678:ISessionDataManager;
      
      private var var_2214:FriendListLookAndFeel;
      
      private var var_428:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1599:OpenedToWebPopup;
      
      private var var_2215:int;
      
      var var_95:FriendCategories;
      
      private var var_327:FriendRequests;
      
      private var var_1598:AvatarSearchResults;
      
      private var var_173:IHabboToolbar;
      
      private var var_875:IHabboNotifications;
      
      private var var_555:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2214 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1598 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_555.stop();
            this.var_555.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_555 = null;
         }
         ...
         if(this.var_875)
         {
            this.var_875.release(new IIDHabboNotifications());
            this.var_875 = null;
         }
         if(this.var_173)
         {
         ...
         if(this.var_678)
         {
            this.var_678.release(new IIDSessionDataManager());
            this.var_678 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1599 = new OpenedToWebPopup(this);
         }
         this.var_1599.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_94,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_327.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_173.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_295,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1037.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_172.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_172.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_173 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_875 = param2 as IHabboNotifications;
      ...
      {
         this.var_678 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_327 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_95.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1196,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_405,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_95.addFriend(new Friend(_loc4_));
         }
         this.var_428 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_555)
         {
            this.var_555 = new Timer(120000);
            this.var_555.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_555.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_405);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_428.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_366));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_327.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_327.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_428.findTab(FriendListTab.const_96).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_327.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_428.findTab(FriendListTab.const_96);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1598.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_428.findTab(FriendListTab.const_96);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_678 || !this.var_327)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_678.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_327.vipLimit;
         }
         else if(this.var_678.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
            _loc2_ = this.var_327.clubLimit;
         }
         if(_loc2_ > this.var_327.limit)
         {
            this.var_327.limit = _loc2_;
         }
      }
