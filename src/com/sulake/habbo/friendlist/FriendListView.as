package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1671:String = "noconvinfo";
      
      private static const const_1670:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1280:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1280 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_932 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_254 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1280.prepare(this.var_932);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1179,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_977,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_805,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_867,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_805,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_867,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1279 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1279.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1565 == -1 ? 0 : int(this.var_16.height - this.var_1565);
         var _loc4_:int = this.var_1566 == -1 ? 0 : int(this.var_16.width - this.var_1566);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_254.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1083,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_805,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1179,false);
         ...
         this.var_1565 = this.var_16.height;
         this.var_1566 = this.var_16.width;
