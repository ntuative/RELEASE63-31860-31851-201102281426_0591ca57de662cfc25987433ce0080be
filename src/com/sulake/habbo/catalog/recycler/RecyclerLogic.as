package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_967:int = 0;
      
      private static const const_420:int = 1;
      ...
      {
         return this.var_633 != const_967;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1897 != RecyclerStatusMessageEvent.const_983;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_633 == const_420;
      }
      ...
      {
         this.var_633 = const_968;
         this.var_116 = new Array(const_190);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1897)
         {
            case RecyclerStatusMessageEvent.const_1484:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_983:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1585:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1129:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1455:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_116.length < const_190)
         {
            return false;
         }
         var _loc1_:int = 0;
