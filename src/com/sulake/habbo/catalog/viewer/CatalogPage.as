package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1661:String = "ctlg_";
      ...
      private var var_1140:ICatalogViewer;
      ...
      private var var_1121:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1661 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1566:
               if(this.var_1121 == null)
               {
                  this.var_1121 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1121);
               }
               break;
            case CatalogWidgetEnum.const_1643:
            ...
            case CatalogWidgetEnum.const_1417:
               ...
               break;
            case CatalogWidgetEnum.const_1478:
               this.var_48.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1551:
            ...
            case CatalogWidgetEnum.const_1463:
               ...
               break;
            case CatalogWidgetEnum.const_1441:
               this.var_48.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1432:
            ...
            case CatalogWidgetEnum.const_1583:
               ...
               break;
            case CatalogWidgetEnum.const_1473:
               this.var_48.push(new RecyclerPrizesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1386:
            ...
            case CatalogWidgetEnum.const_1388:
               ...
               break;
            case CatalogWidgetEnum.const_1401:
