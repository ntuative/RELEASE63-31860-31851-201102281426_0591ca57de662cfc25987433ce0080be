package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_970:IButtonWindow;
      
      private var var_969:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_970.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_970 = null;
         }
         if(this.var_969 != null)
         {
            this.var_969.removeEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
            this.var_969 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_970 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_970 != null)
         {
            this.var_970.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_969 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_969 != null)
         {
            this.var_969.addEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
         }
         return true;
      }
