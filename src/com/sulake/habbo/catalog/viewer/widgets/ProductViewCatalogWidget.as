package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_471:IItemGridWindow;
      
      private var var_1333:IScrollbarWindow;
      
      protected var var_1816:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_872 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1074 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1671 = new Point(this.var_84.x,this.var_84.y);
         this.var_471 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1333 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_471 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1816 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1672 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_471 != null)
         {
            this.var_471.visible = false;
            this.var_471.destroyGridItems();
         }
         ...
         this.var_872.text = _loc4_;
         this.var_1074.text = _loc5_;
         this.var_872.height = this.var_872.textHeight + 5;
         this.var_1074.y = this.var_872.y + this.var_872.height;
         this.var_1074.height = Math.max(130,this.var_1074.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_492:
                  _loc6_ = this.var_1672.clone();
                  if(this.var_471 != null)
                  {
                     this.var_471.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_471,this.var_1333,this.var_1816);
                     this.var_471.scrollV = 0;
                  }
                  break;
               case Offer.const_494:
               case Offer.const_523:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_256:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_49,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_273,AvatarAction.const_553);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2345)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2345 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1671.x;
            this.var_84.y = this.var_1671.y;
            if(param3 != null)
            {
