package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      {
         super(param1);
         this.var_999 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         var _loc1_:String = this.var_1381.getValue(this.var_716.productContainer.firstProduct.extraParam.toLowerCase());
