package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1956:int = 10;
      ...
      private const const_1690:uint = 4.293848814E9;
      
      private const const_1689:uint = 4.294967295E9;
      
      private const const_1957:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_685 = _loc1_.boxTypes;
            this.var_686 = _loc1_.ribbonTypes;
            this.var_1047 = this.var_1620[0];
            this.var_332 = this.var_685[0];
            this.var_331 = this.var_686[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_331 < 0)
         {
            this.var_331 = this.var_686.length - 1;
         }
         if(this.var_331 > this.var_686.length - 1)
         {
            this.var_331 = 0;
         }
         if(this.var_332 < 0)
         {
            this.var_332 = this.var_685.length - 1;
         }
         if(this.var_332 > this.var_685.length - 1)
         {
            this.var_332 = 0;
         }
         var _loc1_:int = this.var_685[this.var_332] * 1000 + this.var_686[this.var_331];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1047,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1304 = _loc3_.id;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1047);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_685[this.var_332]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_686[this.var_331]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_91,this.var_1303,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_91.offerId,this.var_1303);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_101:
               ...
               for each(_loc7_ in this.var_220)
               {
                  ...
                  if(_loc5_.length >= this.const_1956)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2259 = _loc3_.text;
               break;
            ...
            case WindowKeyboardEvent.const_360:
               ...
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_330 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_330 + 1);
                     break;
      ...
      {
         if(this.var_237 == null || !this.var_237.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_237.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_330) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_237 == null)
         {
            this.var_237 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_559 == null)
         {
            this.var_559 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_559.procedure = this.suggestionsEventHandler;
         }
         if(this.var_237 == null || this.var_559 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_237.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_559.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_330) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_330);
         }
         this.var_330 = param1;
         if(this.var_330 < 0)
         {
            this.var_330 = _loc2_.numListItems - 1;
         }
         if(this.var_330 >= _loc2_.numListItems)
         {
            this.var_330 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_330) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1957;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1690) : uint(this.const_1689);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_237.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1047;
               }
            }
            _loc4_++;
         }
