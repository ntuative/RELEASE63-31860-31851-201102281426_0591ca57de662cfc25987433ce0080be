package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_418:uint = 3;
      
      private static const const_1304:uint = 1;
      ...
      private var var_914:IWindowRenderer;
      
      private var var_811:ISkinContainer;
      
      private var var_347:Array;
      
      private var var_1388:IEventDispatcher;
      
      private var var_1104:Boolean = false;
      
      private var var_1753:ProfilerOutput;
      
      private var var_1386:ProfilerAgentTask;
      
      private var var_1387:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_811 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_914 = new WindowRenderer(this.var_811);
         this.var_192 = new Array(const_418);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_418)
         {
            this.var_192[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_914,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_192[const_1304];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_376,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1365,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1753)
            {
               this.var_1753 = new ProfilerOutput(context,this,this.var_914);
            }
            this.var_1753.profiler = _loc3_;
            this.var_1386 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1386);
            this.var_1387 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1387);
            this.var_1104 = true;
         }
      }
      ...
      {
         return this.var_811.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1388.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_418 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1388.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_418)
         {
         ...
         this.var_1388.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1564,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1588,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1475,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1468,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_540,
            "style":WindowStyle.const_182,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
