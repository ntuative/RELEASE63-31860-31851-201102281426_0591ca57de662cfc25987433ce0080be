package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1411:String = "cone";
      
      public static const const_1539:String = "plane";
      
      public static const const_1649:String = "sphere";
      ...
      private var var_824:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_823 = 0;
         this.var_962 = false;
         this.init(0,0,0,this._direction,this.var_2102,this.var_824,this.var_2103,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2100)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_824,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1013.length);
         return this.var_1013[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_823 < this.var_1263)
         {
            if(this.age % this.var_2099 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_823 < this.var_1263)
         {
            ...
            this.y = (2 - this.var_230) * this.y - (1 - this.var_230) * this.lastY + this.var_1532 * this.var_824 * this.var_824;
         ...
         for each(_loc2_ in this.var_320)
         {
            ...
            _loc2_.y = (2 - this.var_230) * _loc2_.y - (1 - this.var_230) * _loc2_.lastY + this.var_1532 * this.var_824 * this.var_824;
