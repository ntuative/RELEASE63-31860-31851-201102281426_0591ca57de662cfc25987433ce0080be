package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1244:Number = 30;
      ...
      {
         this.var_666 = new Vector3d(0,0,0);
         this._children = new Array();
         super();
         this._name = param1;
         this._index = param2;
         this.var_1259 = param3;
         this.var_2141 = param4 * 0 * 2 / 360;
         this.var_1557 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1022 = 0;
      }
      ...
      {
         var _loc3_:Number = this.var_1259 * Math.cos(this.var_1022 + this.var_1557);
         var _loc4_:Number = this.var_1259 * Math.sin(this.var_1022 + this.var_1557);
         var _loc5_:Number = this._height;
         this.var_666.x = (_loc3_ - _loc4_) * (param2 / 2);
         this.var_666.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - this._height * (param2 / 2);
         this.var_666.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            this.var_666.add(param1);
         }
         return this.var_666;
      }
