package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_923:int = 1000;
      
      private static const const_1287:String = "pet_experience_bubble_png";
      
      private static const const_1286:int = 0;
      
      private static const const_1288:int = 1;
      ...
      private var var_293:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_293 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_293.commonAssets != null)
         {
            _loc3_ = this.var_293.commonAssets.getAssetByName(const_1287) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_369);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_234);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_351) > 0;
            this.var_1838 = _loc3_.getNumber(RoomObjectVariableEnum.const_311);
            this.var_1340 = _loc3_.getNumber(RoomObjectVariableEnum.const_721);
            this.var_2244 = _loc3_.getNumber(RoomObjectVariableEnum.const_838);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1686)
            {
               this.var_1686 = _loc6_;
               this.var_2366 = this.var_1686.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1340 > 0)
            {
               _loc2_ = param1 - this.var_1340;
               if(_loc2_ < const_923)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_923 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_257 = param1;
            _loc3_ = this.var_293.getAnimationForPosture(var_184,param1);
            this.setAnimationForIndex(const_1286,_loc3_);
         }
         if(param2 != this.var_1428)
         {
            this.var_1428 = param2;
            _loc3_ = this.var_293.getAnimationForGesture(var_184,param2);
            this.setAnimationForIndex(const_1288,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2366);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_596)
         {
            ...
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_532.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_532[param2];
               if(_loc4_ == 1)
               {
