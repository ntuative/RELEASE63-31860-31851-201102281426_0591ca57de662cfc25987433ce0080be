package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_389:int = 1000;
      ...
      private var var_738:DirectionData = null;
      
      private var var_252:Map;
      
      private var _colors:Map;
      
      private var var_1124:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_738 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_252 != null)
         {
            ...
            {
               _loc2_ = this.var_252.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_738,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_252.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_738);
            this.defineDirection(_loc3_,_loc8_);
            this.var_252.add(String(_loc7_),_loc3_);
            this.var_1797 = -1;
            this.var_1124 = null;
            _loc5_++;
         }
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(this.var_252.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_252.getKey(_loc5_)) * this.var_1402;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_252.getKey(_loc4_));
         }
         return const_1606;
      }
      ...
      {
         if(param1 == this.var_1797)
         {
            return this.var_1124;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_252.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_738;
         }
