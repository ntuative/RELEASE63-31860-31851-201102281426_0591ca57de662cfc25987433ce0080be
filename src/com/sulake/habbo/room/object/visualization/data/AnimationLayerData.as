package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_224[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!this.var_1833)
         {
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < this.var_224.length)
            {
               _loc2_ = this.var_224[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc7_ = this.var_224.length * Math.random();
         _loc2_ = this.var_224[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= this.var_224.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = this.var_224[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc9_ = this.var_1832 * _loc8_;
            if(param3)
            {
               _loc9_ = 0;
            }
            _loc10_ = false;
            if(!this.var_1833 && !param2.isRandom)
            {
               if(param4 == this.var_224.length - 1 && param1 == param2.frameCount - 1)
               {
                  _loc10_ = true;
               }
            }
