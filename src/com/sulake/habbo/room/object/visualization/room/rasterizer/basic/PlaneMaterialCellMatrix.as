package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_216:int = 4;
      
      public static const const_236:int = 5;
      
      public static const REPEAT_MODE_RANDOM:int = 6;
      
      public static const const_1490:int = const_395;
      ...
      public static const const_321:int = const_114;
      ...
      private var var_654:Vector3d = null;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_654 != null)
         {
            this.var_654.assign(new Vector3d());
         }
         this.var_639 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_370.length)
         {
            _loc2_ = this.var_370[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      public function createColumn(param1:int, param2:int, param3:Array, param4:int = 1) : Boolean
      {
         ...
         var _loc6_:PlaneMaterialCellColumn = this.var_370[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_370[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this.var_654,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_639,param6,param7);
                     return param1;
                  }
                  return this.var_29;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_370.length)
         {
            _loc11_ = this.var_370[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1913 == const_114)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_639);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_639,this.var_29.width,this.var_639);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_370.length == 1)
         {
            _loc4_ = this.var_370[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
