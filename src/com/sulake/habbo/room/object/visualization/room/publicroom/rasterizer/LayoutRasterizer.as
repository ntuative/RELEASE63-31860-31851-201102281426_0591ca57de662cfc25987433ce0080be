package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1518:XMLList;
      
      private var _offsetX:int;
      
      private var var_1038:int;
      
      private var var_2527:Vector3d;
      ...
      private var var_1410:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_937)
         {
            this.var_937 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1410 = this.var_43.getValue(this.var_937);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2527 = new Vector3d(-0.5,0.5,0);
         this.var_938 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2527);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_43.getValue(this.var_937);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1809 = RoomObjectVariableEnum.const_1209;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1809 = RoomObjectVariableEnum.const_1048;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_43.getValue(this.var_937);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2528 && param3 == this.var_2526)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1809);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_564;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1410.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_425.indexOf(_loc10_) >= 0 && this.var_938)
            {
               param1 = this.var_425.indexOf(_loc10_);
               if(this.var_610[param1] != "")
               {
                  _loc9_ = this.var_713.getAsset(this.var_610[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               this.var_425.splice(param1,1);
               this.var_610.splice(param1,1);
               this.var_609.splice(param1,1);
               if(this.var_425.length == 0)
               {
                  this.var_938 = false;
               }
            }
      ...
      {
         this.var_938 = true;
         var _loc3_:int = this.var_425.indexOf(param1);
         if(_loc3_ < 0)
         {
