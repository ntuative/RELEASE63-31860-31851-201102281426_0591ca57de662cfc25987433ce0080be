package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1093:Vector3d = null;
      
      private var var_78:Vector3d = null;
      
      private var var_306:Vector3d = null;
      
      private var var_307:Vector3d = null;
      ...
      private var var_892:IPlaneRasterizer = null;
      
      private var var_721:PlaneMaskManager = null;
      ...
      private var var_709:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1363 = [];
         super();
         this.var_2396 = param8;
         this.var_1093 = new Vector3d();
         this.var_1093.assign(param1);
         this.var_78 = new Vector3d();
         this.var_78.assign(param2);
         this.var_306 = new Vector3d();
         this.var_306.assign(param3);
         this.var_307 = new Vector3d();
         this.var_307.assign(param4);
         this.var_592 = Vector3d.crossProduct(this.var_306,this.var_307);
         if(this.var_592.length > 0)
         {
            this.var_592.mul(1 / this.var_592.length);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      {
         return this._isVisible && this.var_709;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_892.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_709 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_344))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_307.length * param1.scale;
            _loc7_ = param1.getCoordinatePosition(this.var_592);
            _loc4_ = this.getTextureIdentifier(param1.scale);
            ...
            if(this.var_892 != null)
            {
               _loc3_ = this.var_892.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1715,this.var_2400,this.var_2397,this.var_2399,this.var_2401,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1687 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_709)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1362.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1362[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1093);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_152.z - originZ,this.var_112.z - originZ,this.var_85.z - originZ,this.var_113.z - originZ);
            if(this._type == const_95)
            {
               relativeDepth += 0.02;
            }
            this.var_2398 = relativeDepth;
            this._isVisible = true;
            this.var_1687 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2396);
      ...
      {
         this.var_152.assign(param1.getScreenPosition(this.var_78));
         this.var_112.assign(param1.getScreenPosition(Vector3d.sum(this.var_78,this.var_307)));
         this.var_85.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_78,this.var_306),this.var_307)));
         this.var_113.assign(param1.getScreenPosition(Vector3d.sum(this.var_78,this.var_306)));
         this._offset = param1.getScreenPoint(this.var_1093);
         ...
         var _loc2_:Number = Math.min(this.var_152.x,this.var_112.x,this.var_85.x,this.var_113.x);
         var _loc3_:Number = Math.max(this.var_152.x,this.var_112.x,this.var_85.x,this.var_113.x);
         var _loc4_:Number = Math.min(this.var_152.y,this.var_112.y,this.var_85.y,this.var_113.y);
         var _loc5_:Number = Math.max(this.var_152.y,this.var_112.y,this.var_85.y,this.var_113.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_152 == null || this.var_112 == null || this.var_85 == null || this.var_113 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         ...
         if(this._type == const_109 || this._type == const_95)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_109 || this._type == const_95))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_245.length == this.var_894.length)
         {
            while(_loc1_ < this.var_245.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_894.length)
                  {
                     _loc7_ = this.var_894[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_343.length > this.var_1363.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_893 || this.var_245.length == 0 && this.var_343.length == 0 && !this.var_344 || this.var_721 == null)
         {
            return;
         }
         ...
         if(this.var_344)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_592);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_245.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_307.length;
                  _loc12_ = _loc3_.type;
                  this.var_721.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_894.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_343.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_307.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_306.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_307.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_218.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_218.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_218,this.var_218.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
