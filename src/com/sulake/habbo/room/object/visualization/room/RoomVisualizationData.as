package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_720:WallAdRasterizer;
      
      private var var_484:LandscapeRasterizer;
      
      private var var_721:PlaneMaskManager;
      ...
      public function RoomVisualizationData()
      {
         ...
         this.var_720 = new WallAdRasterizer();
         this.var_484 = new LandscapeRasterizer();
         this.var_721 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc9_ = _loc4_[0];
            this.var_720.initialize(_loc9_);
         }
         var _loc5_:XMLList = param1.landscapeData;
         if(_loc5_.length() > 0)
         {
            _loc10_ = _loc5_[0];
            this.var_484.initialize(_loc10_);
         }
         var _loc6_:XMLList = param1.maskData;
         if(_loc6_.length() > 0)
         {
            _loc11_ = _loc6_[0];
            this.var_721.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_720.initializeAssetCollection(param1);
         this.var_484.initializeAssetCollection(param1);
         this.var_721.initializeAssetCollection(param1);
         this.var_767 = true;
      }
