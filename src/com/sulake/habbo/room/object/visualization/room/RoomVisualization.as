package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1632:int = 16777215;
      
      public static const const_1362:int = 13421772;
      
      private static const const_949:int = 16777215;
      
      private static const const_948:int = 13421772;
      
      private static const const_947:int = 10066329;
      
      private static const const_946:int = 10066329;
      
      public static const const_1485:int = 16777215;
      
      public static const const_1595:int = 13421772;
      
      public static const const_1554:int = 10066329;
      ...
      private var var_498:RoomPlaneBitmapMaskParser = null;
      
      private var var_1732:String = null;
      
      private var _floorType:String = null;
      
      private var var_1733:String = null;
      
      private var var_2550:String = null;
      
      private var var_1138:uint = 16777215;
      
      private var var_2548:int = 255;
      
      private var var_2551:int = 255;
      
      private var var_2549:int = 255;
      ...
      private const const_1981:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_498 = new RoomPlaneBitmapMaskParser();
         this.var_298["null"] = false;
         this.var_298["null"] = true;
         this.var_298["null"] = true;
         this.var_298["null"] = true;
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_985);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_987);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_306)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1485;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1595;
               }
               else
               {
                  _loc13_.color = const_1554;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1575)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_109,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_306)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1981 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_355.length)
            {
               _loc10_ = this.var_612[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_355[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_95)
               {
                  if(this.var_1814)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2549 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2551 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2548 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1687)
         {
            this.var_1687 = param1.updateId;
            this.var_746 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1445 || _loc3_.y != this.var_2545 || _loc3_.z != this.var_2547 || param1.scale != this.var_2546))
            {
               this.var_1445 = _loc3_.x;
               this.var_2545 = _loc3_.y;
               this.var_2547 = _loc3_.z;
               this.var_2546 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1195);
            if(_loc3_ != this.var_2550)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2550 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_797));
            if(_loc4_ != this.var_1138)
            {
               this.var_1138 = _loc4_;
               this.var_2549 = this.var_1138 & 255;
               this.var_2551 = this.var_1138 >> 8 & 255;
               this.var_2548 = this.var_1138 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1200));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_163 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_712);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_850);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_778);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_742));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_676));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_649));
      ...
      {
         if(param1 != this.var_298["null"] || param2 != this.var_298["null"] || param3 != this.var_298["null"])
         {
            this.var_298["null"] = param1;
            this.var_298["null"] = param2;
            this.var_298["null"] = param3;
            this.var_355 = [];
            this.var_612 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_355;
         if(this.var_355.length == 0)
         {
            _loc6_ = this.var_132;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_355.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_298[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1682;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_498.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_498.maskCount)
         {
            _loc10_ = this.var_498.getMaskType(_loc8_);
            _loc11_ = this.var_498.getMaskLocation(_loc8_);
            _loc12_ = this.var_498.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_132.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_109 || _loc3_.type == RoomPlane.const_95)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_109 || _loc3_.type == RoomPlane.const_95 && _loc12_ == RoomPlaneBitmapMaskData.const_239)
                              {
