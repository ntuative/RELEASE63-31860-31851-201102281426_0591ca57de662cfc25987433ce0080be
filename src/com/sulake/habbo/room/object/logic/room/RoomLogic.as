package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1243:uint = 16777215;
      
      private var var_1496:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_985,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_797,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_742,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_676,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_649,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1001)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1493;
            if(_loc2_ - this.var_1001 >= this.var_1494)
            {
               _loc3_ = this.var_1000;
               _loc4_ = this.var_1495;
               this.var_1001 = 0;
            }
            else
            {
               _loc7_ = this.var_1243 >> 16 & 255;
               _loc8_ = this.var_1243 >> 8 & 255;
               _loc9_ = this.var_1243 & 255;
               _loc10_ = this.var_1000 >> 16 & 255;
               _loc11_ = this.var_1000 >> 8 & 255;
               _loc12_ = this.var_1000 & 255;
               _loc13_ = (_loc2_ - this.var_1001) / this.var_1494;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1496 + (this.var_1495 - this.var_1496) * _loc13_;
               this._color = _loc3_;
               this.var_1493 = _loc4_;
            }
            _loc5_ = ColorConverter.rgbToHSL(_loc3_);
            _loc5_ = (_loc5_ & 16776960) + _loc4_;
            _loc3_ = ColorConverter.method_5(_loc5_);
            _loc6_ = object.getModel() as IRoomObjectModelController;
            if(_loc6_ == null)
            {
               return;
            }
            _loc6_.setNumber(RoomObjectVariableEnum.const_797,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_897:
               param2.setString(RoomObjectVariableEnum.const_850,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_766:
               param2.setString(RoomObjectVariableEnum.const_712,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_794:
               param2.setString(RoomObjectVariableEnum.const_778,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_453:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_239)
               {
                  _loc5_ = "null";
               }
               this.var_498.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_853:
               _loc4_ = this.var_498.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_498.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1195,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1081:
               param2.setNumber(RoomObjectVariableEnum.const_742,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1059:
               param2.setNumber(RoomObjectVariableEnum.const_676,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_649,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1200,int(param1.bgOnly));
         this.var_1243 = this._color;
         this.var_1496 = this.var_1493;
         this.var_1000 = _loc3_;
         this.var_1495 = _loc4_;
         this.var_1001 = getTimer();
         this.var_1494 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_455,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1453,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1389,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1379,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_455,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_162 || _loc13_ == RoomPlaneData.const_306)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
