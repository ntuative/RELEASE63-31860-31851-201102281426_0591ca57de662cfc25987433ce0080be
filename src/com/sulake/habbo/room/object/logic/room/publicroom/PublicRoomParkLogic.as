package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1219:String = "goawaybus";
      
      private static const const_1220:String = "bus";
      
      private static const const_1221:String = "bus_oviopen_hidden";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1219:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_442,0,_loc4_,_loc5_);
                     break;
                  case const_1220:
                  case const_1221:
