package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_773:Number = 64;
      
      public static const const_1102:Number = 32;
      ...
      private var var_1801:Number = 1.0;
      
      private var var_78:Vector3d;
      
      private var var_253:Vector3d;
      
      private var var_2788:Number = -500.0;
      
      private var var_2787:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1801 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_141.x,this.var_141.y,this.var_141.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_78.x * this.var_422,this.var_78.y * this.var_423,this.var_78.z * this.var_424);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_253.x,this.var_253.y,this.var_253.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_422 != param1 * this.var_1802)
         {
            this.var_422 = param1 * this.var_1802;
            ++this.var_156;
         }
      }
      ...
      {
         if(this.var_423 != param1 * this.var_1800)
         {
            this.var_423 = param1 * this.var_1800;
            ++this.var_156;
         }
      }
      ...
      {
         if(this.var_424 != param1 * this.var_1801)
         {
            this.var_424 = param1 * this.var_1801;
            ++this.var_156;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_78.x /= this.var_422;
         this.var_78.y /= this.var_423;
         this.var_78.z /= this.var_424;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_253.x;
         var _loc3_:Number = this.var_253.y;
         var _loc4_:Number = this.var_253.z;
         this.var_253.assign(param1);
         if(this.var_253.x != _loc2_ || this.var_253.y != _loc3_ || this.var_253.z != _loc4_)
         {
            ++this.var_156;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_141.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_142.assign(_loc19_);
            this.var_141.assign(_loc20_);
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_496 != null)
         {
            ...
            return this.var_496.getValue(_loc2_);
         }
         return null;
      }
      ...
      {
         if(param1 == null || this.var_141 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_141,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_141);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_422;
         _loc2_.y *= this.var_423;
         _loc2_.z *= this.var_424;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1125);
         if(_loc3_ < this.var_2788 || _loc3_ > this.var_2787)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_78.x * this.var_422,this.var_78.y * this.var_423,this.var_78.z * this.var_424);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_141;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_422,param2.y * this.var_423,param2.z * this.var_424);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_422,param3.y * this.var_423,param3.z * this.var_424);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_422,param4.y * this.var_423,param4.z * this.var_424);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1102;
         }
         else
         {
            this.scale = const_773;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_773;
      }
