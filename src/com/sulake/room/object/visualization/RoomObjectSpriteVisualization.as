package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_363:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_190 != null)
         {
            ...
            {
               _loc1_ = this.var_190[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_190.length > param1)
         {
            _loc2_ = this.var_190[this.var_190.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_190.length)
         {
