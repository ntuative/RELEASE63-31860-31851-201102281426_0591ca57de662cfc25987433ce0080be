package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private static const const_1305:int = 10;
       
      
      private var _assets:Map;
      
      private var var_348:IAssetLibrary;
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc2_ < param1.length())
         {
            ...
            if(_loc3_.length() > 0)
            {
               ...
               _loc11_ = this.var_348.getAssetByName(_loc5_);
      ...
      private function definePalettes(param1:XMLList) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            if(XMLValidator.checkRequiredAttributes(_loc3_,_loc2_))
            {
               ...
               if(this.var_232[_loc4_] == null)
               {
                  _loc6_ = this.var_348.getAssetByName(_loc5_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            _loc6_ = new BitmapDataAsset(this.var_348.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_348.setAsset(param1,_loc6_);
      ...
      public function disposeAsset(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_348.removeAsset(_loc3_);
               _loc3_.dispose();
            }
            _loc2_.dispose();
         }
      ...
      {
         return this.var_348.getAssetByName(param1) as BitmapDataAsset;
      }
      ...
      private function addLibraryAsset(param1:String, param2:BitmapData) : BitmapDataAsset
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = new BitmapDataAsset(this.var_348.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_348.setAsset(param1,_loc3_);
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_598 != null)
         {
            if(param1 || this.var_598.length > const_1305)
            {
