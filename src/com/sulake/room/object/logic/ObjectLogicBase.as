package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_363:IRoomObjectController;
      ...
      {
         if(this.var_363 == param1)
         {
            return;
         }
         if(this.var_363 != null)
         {
            this.var_363.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_363 = param1;
            this.var_363.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_363 != null)
            {
               this.var_363.setLocation(param1.loc);
               this.var_363.setDirection(param1.dir);
            }
         }
      }
   }
