package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      {
         var _loc2_:Array = this.var_563[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         if(this.var_1308.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_560[param1] != param2)
         {
            this.var_560[param1] = param2;
            ++this._updateID;
         }
      }
      ...
      {
         if(this.var_1309.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1309.push(param1);
         }
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_563[param1];
