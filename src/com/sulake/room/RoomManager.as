package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2820:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_603 = [];
         this.var_582 = [];
         events.addEventListener(RoomContentLoadedEvent.const_340,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_535,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_664,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_602 == null || this.var_491 == null)
         {
            return;
         }
         this._state = const_1425;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_491.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_491.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_51 == null || this.var_491 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_491.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_491.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
