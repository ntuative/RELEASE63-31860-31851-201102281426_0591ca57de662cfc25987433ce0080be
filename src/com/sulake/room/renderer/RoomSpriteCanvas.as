package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1330:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2342:Number = -1.0E7;
      
      private var var_2340:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_242.addChild(this.var_57);
      ...
      {
         this.var_469.x -= param1 - this.var_570;
         this.var_570 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_469.y -= param1 - this.var_573;
         this.var_573 = param1;
      }
      ...
      {
         if(param1 && !this.var_893)
         {
            this.var_893 = true;
            if(this.var_122 != null && !this.var_242.contains(this.var_122))
            {
               this.var_242.addChild(this.var_122);
               this.var_57.mask = this.var_122;
            }
         }
         else if(!param1 && this.var_893)
         {
            this.var_893 = false;
            if(this.var_122 != null && this.var_242.contains(this.var_122))
            {
               this.var_242.removeChild(this.var_122);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_569.length)
            {
               this.cleanSprite(this.var_569[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_569 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_695 != this.var_2338 || this._ht != this.var_2341)
         {
            _loc9_ = true;
         }
         if(this.var_57.x != this.var_570 || this.var_57.y != this.var_573)
         {
            this.var_57.x = this.var_570;
            this.var_57.y = this.var_573;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2338 = this.var_695;
         this.var_2341 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_570;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_573;
                  if(_loc19_ < this.var_695 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_570;
                     _loc17_.y = _loc20_ - this.var_573;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_569.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_694 || this.var_694 == 0)
         {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_570;
         param2 -= this.var_573;
         this.var_469.x = param1;
         this.var_469.y = param2;
         if(this.var_1070 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1668;
         }
         this.var_1668 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1070;
         return this.var_1668;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_695 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1669,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_571.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_571.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2342 || param2 != this.var_2340)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_571.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_571.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_337.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1330.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1070 == 0)
         {
            this.checkMouseHits(this.var_469.x,this.var_469.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1070 = 0;
         ++this.var_1669;
      }
